                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <%
                                    ...
                                    try {
                                        String resultString = "SELECT * FROM unitobjective WHERE COURSE_ID='" + id + "' AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + " AND UOBJ_ID=" + uobjid + "";
                        ...
                        <%  if (email1.equals("null") && email2.equals("null")) {%>
                        <form method="post" action="unitobj_database1.jsp" name="cog">
