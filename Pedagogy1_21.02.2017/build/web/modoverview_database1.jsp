        ...
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  module SET MODULE_OVERVIEW = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  module SET REVIEWER_COMMENT = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                        }else{
                            queryString = "UPDATE  module SET PEDA_REVIEW = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                            }
