            ...
            <div id="right-main">
                ...
                <div id="screen">
                    <div class="boxc">
                        <%
                                    ...
                                    try {
                                        ...
                                        while (rs2.next()) {
                                            ...
                                            out.println("<tbody>");
                                            out.println("<tr>");
                                            out.println("<td align='left'><h3>Mission.</h3></td>");
                        ...
                        <h2 align="center">Institutes Mission:-</h2>
                        <form method="post" action="mission_database1.jsp" name="cog" onsubmit="return submitForm();">
                            ...
                            <table align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="right" >
                                            <input value="Submit" name="submit" type="submit" onclick=" return submitForm(this.form)" />
                                        </td>
