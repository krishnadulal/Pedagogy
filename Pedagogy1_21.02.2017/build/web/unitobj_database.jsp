...
<html>
    ...
    <body>
        <%
                    ...
                    try {
                        if (text != null) {
                        String queryString1 = "INSERT INTO unitobjective (COGNITIVELEVEL,ACTIONVERBS,OBJECTIVE,TIME,COURSE_ID,MODULE_ID,UNIT_ID) VALUES('" + Cognitivelevel + "' ,'" + Actionverbs + "' ,'" + text3 + "' , now(),'" + id + "','" + moduleid + "','" + unitid + "')";
                        pstatement = connection.prepareStatement(queryString1);
                        updateQuery2 = pstatement.executeUpdate();
                        } else {
                        for (int s = 0; s < objectives.length; s++) {
                                ResultSet rs2 = null;
                                String queryString2 = "SELECT * FROM unitobjective where UOBJ_ID=" + objectives[s] + "";
                                pstatement = connection.prepareStatement(queryString2);
                                rs2 = pstatement.executeQuery();
                                while (rs2.next()) {
                                    String queryString3 = "INSERT INTO unitobjective (COGNITIVELEVEL,ACTIONVERBS,OBJECTIVE,TIME,COURSE_ID,MODULE_ID,UNIT_ID) VALUES('" + rs2.getString(2) + "' ,'" + rs2.getString(3) + "' , '" + rs2.getString(4) + "' , now(),'" + id + "','" + moduleid + "','" + unitid + "')";
