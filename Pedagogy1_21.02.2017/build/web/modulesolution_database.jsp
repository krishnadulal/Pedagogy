<%-- 
    Document   : modulesolution_database
    Created on : Sep 10, 2013, 5:19:27 PM
    Author     : Prasanta
--%>
...
<%@page import=" org.apache.poi.xwpf.*" %>
...
<html>
    ...
    <body>
        <%
                    ...
                    String mprob_id = request.getParameter("MPROB_ID");
                    ...
                    String c = b.concat(".");
                    String Filename = c.concat(mprob_id);
                    File file;
                    String format = "none";
                    ...
                    try {
                        String queryString1 = "UPDATE moduleproblem SET SOLUTION_FILE=? WHERE MPROB_ID='" + mprob_id + "' AND COURSE_ID='" + id + "' AND MODULE_ID='" + module_id + "' ";
