        ...
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  unitproblem SET  PROBLEM = ?,PROBLEMOBJECTIVE=? WHERE COURSE_ID=" + id + " AND UPROB_ID=" + uprobid + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  unitproblem SET  REVIEWER_COMMENT = ? WHERE COURSE_ID=" + id + " AND UPROB_ID=" + uprobid + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                         }else{
                            queryString = "UPDATE  unitproblem SET  PEDA_REVIEW = ? WHERE COURSE_ID=" + id + " AND UPROB_ID=" + uprobid + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                            }
                        if (email1.equals("null") && email2.equals("null")) {
