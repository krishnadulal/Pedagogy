...
window.DevExpress||(function(n,t,i){
    ...
    var a=/left|right/,v=/top|bottom/,o=/fit|flip/,f=function(n){
        ...
        var k=s(o.my),d=s(o.at),h=o.of||window,g=y(o.offset),nt=p(o.collision),c={
            mySize:v.outerWidth(),
            myAlign:k.h,
            atAlign:d.h,
            offset:g.h,
    ...
    function it(){}
    var rt=Math.PI,ut=Math.LN10,ft=Math.cos,et=Math.sin,c=Math.abs,ot=Math.log,st=Math.floor,ht=Math.ceil,ct=Math.max,nr=Math.min,l=window.isNaN,p=window.Number,lt=window.NaN,f=["millisecond","second","minute","hour","day","week","month","quarter","year"],at=function(n){
        return n!==null&&n!==i
    },e=function(t){
        ...
        var i=v(n),r,t;
        if(i)for(t=1;t<=i.length;t++)if(r=y(n,t),r!==0&&i[t-2]&&i[t-1]&&i[t-2]===i[t-1])return r;return n
    },g=function(n){
        var t={};
    ...
    var s={
        ...
        var e=/ipad/i.test(t),u=/iphone|ipod/i.test(t),i=/android|silk-accelerated/i.test(t),r=/windows phone 8|wpdesktop/i.test(t),o=/msie(.*)arm(.*)tablet\spc/i.test(t),f=/msapphost/i.test(t)||r||o;
    ...
    var f=t.translator,e=t.support,o=e.transitionEndEventName+".dxFX",w=/cubic-bezier\((\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\s*,\s*(\d+(?:\.\d+)?)\)/,s="dxSimulatedTransitionTimeoutKey",u="dxAnimData",r="transform",l="backfaceVisibility",b=1e3/60,a={
        ...
        setup:function(n,t){
            if(e.transform3d){
                var i=t.from,u=t.to,f="opacity"in i?i.opacity:n.css("opacity"),o="opacity"in u?u.opacity:1,s="scale"in i?i.scale:0,h="scale"in u?u.scale:1;
                t.from={
                    opacity:f
        ...
        setup:function(n,t){
            if(e.transform3d){
                var u=t.from,i=t.to,o=this._normalizeDirection(i.direction),f=this._getDirectionFactor(o),s=this._getAxis(o),h="rotate"in u?u.rotate:-f*180,c="rotate"in i?i.rotate:f*180,a="scale"in u?u.scale:f===1?1:.8,v="scale"in i?i.scale:f===1?.8:1;
    ...
    t.NumericFormat={
        ...
        _formatDateEx:function(t,r){
            var u=this,l="Q",c=r.format,f=r.dateType,h=Globalize.culture().calendars.standard,o=i,s,e;
    ...
    var o=t.Class,r=t.abstract,u=t.data,f=u.utils.normalizeSortingInfo,s=["loading","loaded","modifying","modified","inserting","inserted","updating","updated","removing","removed"],e=function(t,i){
    ...
    r.ArrayStore=r.Store.inherit({
        ...
        _indexByKey:function(n){
            for(var t=0,i=this._array.length;t<i;t++)if(r.utils.keysEqual(this.key(),this._keyGetter(this._array[t]),n))return t;return-1
        }
    })
}(jQuery,DevExpress),function(n,t){
    ...
    var r=t.data,c=t.Class,s="__key__",l=n.Deferred().resolve([]).promise(),f=c.inherit({
        ...
        _localIndexByKey:function(n){
            for(var i=this._items,f=i.length,e=this._store.key(),u,t=0;t<f;t++)if(u=i[t][s],r.utils.keysEqual(e,u,n))return t;return-1
        },
    ...
    r.Store.redefine({
        toDataSource:function(t,i){
            ...
            if(t=n.extend({
                store:this
            },t),n.isFunction(i))r=new i(t);else switch(i){
                case"simple":
                    r=new e(t);
                    break;
                default:
    ...
    var ut=t.social,r=window.location,ft=window.navigator,p=window.encodeURIComponent,et=window.decodeURIComponent,o=ft.standalone,s=!1,y;
    if(window.cordova)n(document).on("deviceready",function(){
        s=!0
    });
    var w="dx-facebook-access-token",h="dx-facebook-step1",c="dx-facebook-step2",u=null,b=null,k=n.Callbacks(),f,d=function(){
        return!!u
    },ot=function(){
        return{
            accessToken:u,
        ...
        var u=(t.permissions||[]).join(),i="https://www.facebook.com/dialog/oauth?display=popup&client_id="+n+"&redirect_uri="+p(f)+"&scope="+p(u)+"&response_type=token";
    ...
    var u=t.ui,o={
    ...
    },r="dx-dialog",s=r+"-root",h=r+"-content",c=r+"-message",l=r+"-buttons",a=r+"-button",f=function(i){
        ...
        return p=this,e=n.Deferred(),i=n.extend(u.optionsByDevice(t.devices.current(),"dxDialog"),i),k=n(".dx-viewport"),d=n("<div/>").addClass(r).appendTo(k),g=n("<div/>").addClass(c).html(String(i.message)),y=n("<div/>").addClass(l),f=d.dxPopup({
            ...
            var i=n("<div/>").addClass(a).appendTo(y),r=new t.Action(this.clickAction,{
                context:f
            });
    ...
    if(r){
        ...
        var e=t.ui,y=t.inflector,o="data-bind",p="unknown",tt="_",c="dxKoLocks",l="M2O",a="O2M",w="dxKoCreation",s=r.bindingProvider.instance,b=r.jsonExpressionRewriting.parseObjectLiteral,v=n("<div><\/div>"),it=function(n){
        ...
        r.bindingProvider.instance=rt,h=e.Template.inherit({
            ...
            update:function(i,u,f,e){
                var o=n(i),s=r.utils.unwrapObservable(u()),h=new t.Action(s,{
                    context:i
                });
    ...
    var u=t.ui,f=t.support,r=f.touch,e=400,o=function(){
        var u=null,o=n.Callbacks(),f,s=function(n){
            ...
            return!!f
        },v=/^4\.0/.test(t.devices.androidVersion())&&navigator.userAgent.indexOf("Chrome")===-1,y=function(){
    ...
    t.ui.DataHelperMixin={
        ...
        _initDataSource:function(){
            var i=this,o=i.option("dataSource"),s,h=u in this?this[u]():{},c=i._dataSourceType?i._dataSourceType():r.SimpleDataSource;
            if(i._disposeDataSource(),o){
                if(n.isArray(o))s=new r.ArrayStore(o).toDataSource(h,c);
                else if(n.isPlainObject(o))if("load"in o)s=r.createDataSource(o);
                    else{
                ...
                else if(o instanceof r.Store)s=o.toDataSource(h,c);else throw Error("Invalid dataSource option");
    ...
    var e="dxSpecialEvents",f=e+"HoldTimer",u=new t.ui.EventHelper(e),s=u.eventName("start"),h=u.eventName("end"),v=u.eventName("cancel"),c=n.event,l=c.special,y=l["dx:hold"]={
        HOLD_TIMEOUT:750,
        setup:function(t){
    ...
    var f="dxComponents",e=!!window.ko,r=t.ui,u=t.data.utils,l="dx-state-disabled",a=t.Class.inherit({
        ...
        ctor:function(i,u){
            ...
            try{
                var e=t.devices.current(),o=r.optionsByDevice(e,this.NAME)||{},s=n.extend(this._defaultOptions(),o);
    ...
    var u=t.ui,l="UIFeedback",f="dx-feedback",h="dx-state-active",a="dx-state-disabled",v="dx-state-invisible",y=30,p=400,r,e=new u.EventHelper(l),o=!1;
    u.feedback={
        lock:function(){
            o=!0
        },
    ...
    var r=t.ui,u="template",f=function(t){
        ...
        _initTemplates:function(){
            var t={},i=this._templateProvider.getTemplateClass(this),r=this._element().children("[data-options]");
    ...
    var r=t.ui,u=r.ContainerWidget.inherit({
        ...
        _renderEmptyMessage:function(){
            var i=this.option("noDataText"),t=this._element().find(".dx-empty-message"),r=this.option("items"),u=r&&r.length;
        ...
        _renderItem:function(n,t,i){
            ...
            var f=this.option("itemRender"),o=this.option("itemTemplate"),e=this._getTemplate(t.template||o,n,t),r,u={
                index:n,
                item:t,
                container:i
            };
        ...
        _handleItemEvent:function(t,i,r){
            var u=n(t.target).closest(this._itemSelector()),f=this._createActionByOption(i,{
                element:this._element()
            }),e=n.extend({
                itemElement:u,
    ...
    t.ui.optionsByDevice=function(n,t){
        ...
        if(t==="dxPopup"&&n.platform==="win8")return{
            width:"60%",
            height:"auto"
        };
        ...
        if(t==="dxLookup"){
            ...
            if(n.platform==="win8")return u={
                hideCancelButton:!0
            },n.phone&&(u.fullScreen=!0),u;
...
DevExpress.MOD_VIZ||(function(n){
    ...
    u.outOfScreen={
        ...
        getTickInterval:function(n,t,i,r,u){
            var f=this,r=r||f._defaultGridSpacingFactor,u=u||f._defaultNumberMultipliers,e=i>0?r*t/i:0;
            switch(n){
                case"numeric":
        ...
        _areDisplayValuesValid:function(n,t,i){
            var c=this,e=c._getTextFunc(i),o=i.renderer.drawText(e(n),u.outOfScreen.x+i.translator.translateX(n),u.outOfScreen.y,i.textOptions),s=i.renderer.drawText(e(t),u.outOfScreen.x+i.translator.translateX(t),u.outOfScreen.y,i.textOptions),r=o.getBBox(),f=s.getBBox(),h,l=i.translator.businessRange.invertX;
        ...
        _getRealScreenDelta:function(n,t,i){
            ...
            var o=t.renderer.drawText(i,u.outOfScreen.x+t.translator.translateX(n[0]),u.outOfScreen.y,t.textOptions),s=t.renderer.drawText(i,u.outOfScreen.x+t.translator.translateX(n[n.length-1]),u.outOfScreen.y,t.textOptions),r=s.getBBox(),f=o.getBBox(),h=f.x>r.x,e;
        ...
        getTicks:function(t){
            ...
            if(!r.isDefined(t.min)||!r.isDefined(t.max)||isNaN(t.min)||isNaN(t.max))f=t.isHorizontal?["canvas_position_left","canvas_position_center","canvas_position_right"]:["canvas_position_bottom","canvas_position_middle","canvas_position_top"],y=!1,f.hideLabels=!0;
            else if(o=n.isNumeric(t.min)&&n.isNumeric(t.max)&&!n.isNumeric(t.tickInterval)?i:t.tickInterval,v=Math.abs(t.max-t.min),this.needTickIntervalCalculation(v,o,t.incidentOccured)&&(h=r.isDefined(h)?h:!0,o=u.tickIntervalCalculator.getTickInterval(r.isDate(t.min)?"dateTime":"numeric",Math.abs(t.max-t.min),t.screenDelta,t.gridSpacingFactor,t.numberMultipliers)),o.valueOf()!==0&&t.min.valueOf()!==t.max.valueOf()){
    ...
    t.viz.core.LinearTranslator=f.inherit(function(){
        var f=function(n,t){
            ...
            var n=this,i=n.canvas,u=n.businessRange,f=n.businessRange.categoriesX,e=n.businessRange.categoriesY,o,s;
    ...
    (function(){
        ...
        u=function(n,t,i,r,u){
            ...
            i[e]=function(n){
                ...
                i={
                    sharpEdges:!1
                },i[n.prop]=u(t,n.pos,n.start,n.end,n.unit),t.applySettings(i)
            }
            ...
            i[r]=function(n){
                ...
                t={
                    sharpEdges:!1
                },t[r]=u(i,n.pos,n.start||0,n.end||0,n.unit),i.applySettings(t)
            }
        }),i.d=function(t){
            ...
            n.initialized||(i=n.end,f=t.transformation||{},n.start=f.rotateAngle||0,n.end=i.angle||0,n.x=i.x||0,n.y=i.y||0,n.initialized=!0),e=u(t,n.pos,n.start,n.end),t.applySettings({
                rotate:[e,n.x,n.y]
            })
    ...
    var r=l.inherit({
        ...
        animate:function(t,i,r){
            ...
            }),n(this).stop(),r&&n.extend(i,{
                complete:r
            }),n(this).animate(t,n.extend({
                duration:this.renderer.animOptions.duration
            },i))):(t.translate&&("x"in t.translate&&(t.translateX=t.translate.x),"y"in t.translate&&(t.translateY=t.translate.y),delete t.translate),i&&i.step?(i.step.call(this,undefined,{
                pos:1
            }),i.complete&&i.complete.call(this)):this.applySettings(t))
        },
        show:function(n){
        ...
        _normalizeSettings:function(i){
            ...
            for(o in i){
                ...
                else if(/^(translateX|translateY|rotate)$/i.test(r)){
                    this["_"+r]=u;
                    continue
        ...
        animate:function(t,i){
            ...
            this.fromSegments=this.segments,this.prepareSegments(t),this.renderer.animOptions.enabled&&n.extend(t,{
                d:1
            }),this.callBase=r,this.callBase(t,i)
        },
        sharpEdges:function(){
        ...
        createArcSegments:function(n,t,i,r,u,f){
            var e=Math.abs(f-u)>Math.PI?"1":"0",o=n+r*Math.cos(u),s=t-r*Math.sin(u),h=n+r*Math.cos(f),c=t-r*Math.sin(f),l=n+i*Math.cos(f),a=t-i*Math.sin(f),v=n+i*Math.cos(u),y=t-i*Math.sin(u);
        ...
        prepareSegments:function(n){
            ...
            if("x"in n||"y"in n||"outerRadius"in n||"innerRadius"in n||"startAngle"in n||"endAngle"in n){
                var o=i.isNumber(n.x)?Number(n.x):0,s=i.isNumber(n.y)?Number(n.y):0,u=i.isNumber(n.outerRadius)?Number(n.outerRadius):0,f=i.isNumber(n.innerRadius)?Number(n.innerRadius):0,t=i.isNumber(n.startAngle)?Number(n.startAngle):0,r=i.isNumber(n.endAngle)?Number(n.endAngle):360;
        ...
        _createElementWithText:function(n){
            var t,i;
            this.clear(),n=n.toString().replace(/\r/g,""),n=n.replace(/\n/g,"<br/>"),t=o.createElement("div"),t.innerHTML=n,t.params={
                style:{}
            },this._orderText(t)
        },
        clear:function(){
        ...
        recreateCanvas:function(n,t){
            var i=this,r;
            i.killContainer(),n>0&&t>0&&(r=new a(i,{
                width:n,
                height:t
            }),i.svgRoot=r)
        },
        ...
        createClipRect:function(n,t,u,f){
            ...
            return this.defsSvg||(this.defsSvg=new r(this,"defs"),this.defsSvg.append()),s=i.getNextClipId(),o=new r(this,"clipPath",{
                id:s
            }),o.append(this.defsSvg),e=this.createRect(n,t,u,f,0,h),e.id=s,e.append(o),e
        },
        createPattern:function(n,t){
            ...
            if(this.defsSvg||(this.defsSvg=new r(this,"defs"),this.defsSvg.append()),e=i.getNextPatternId(),u=new r(this,"pattern",{
                ...
                strokeWidth:2,
                stroke:n
            }),f.append(u),u.lines.push(f);
            else if(t==="left")f=this.createLine(5,1,6,0,{
                strokeWidth:1,
                stroke:n,
                opacity:.8
    ...
    var s=t.viz.renderers,u=t.utils,f=document,i=s._svgRendererInternals,y={
        x:0,
        y:0,
        width:1,
        height:1,
        ...
        _applyAttributes:function(n){
            ...
            if(this._isAppended){
                if(n=n||this._delayedAttributes,n){
                    ...
                    for(t in n)i=n[t],t==="opacity"||t==="fillOpacity"||t==="strokeOpacity"||t==="dashstyle"||t==="joinStyle"?p(this,n,t):t==="class"?this.element.className=this.isVml()?"vml "+i:i:this.element[t]=i;delete this._delayedAttributes
                }
        ...
        _normalizeSettings:function(t){
            var c,u={},f={},e,o,r,i,s,h,v=["position","display","visibility","filter","margin","marginTop","marginLeft","marginRight","marginBottom","whiteSpace","clip"];
            for(c in t)if(r=c,i=t[r],r==="x"||r==="translateX")o=t.x||0,t.translateX&&(o+=t.translateX),u.left=o+"px";
                ...
                else if(r==="align")u.textAlign=i;
                else if(n.inArray(r,v)!=-1)u[r]=i;
                else if(r==="fill")this.isVml()?(f.filled=i==="none"?"f":"t",f.fillcolor=i):u.color=i;
                else if(r==="opacity")f.opacity=i<.002?"99f":i;
                else if(r==="stroke")f.stroked=i==="none"?"f":"t",f.strokecolor=i;
                else if(r==="strokeWidth")f.strokeweight=i+"px";
                else if(r==="lineJoin")f.joinStyle=i;
                else if(r==="font"){
                    if(!n.isPlainObject(i))continue;
                    n.each(i,function(n){
                        switch(n){
                            case"color":case"cursor":
                                s=n;
                                break;
                            case"opacity":
                                s="opacity";
                ...
                else if(r==="dashStyle")i=i.toLowerCase(),i!=="solid"&&(f.dashstyle=i);
                else if(r==="clipId"){
                ...
                }else if(r==="segments")continue;else f[r]=i;return this._style=u,f
        },
        _getBBox:function(){
        ...
        createArcSegments:function(n,t,i,r,u,f){
            var e=n+r*Math.cos(u),o=t-r*Math.sin(u),s=n+r*Math.cos(f),h=t-r*Math.sin(f),c=n+i*Math.cos(f),l=t-i*Math.sin(f),a=n+i*Math.cos(u),v=t-i*Math.sin(u);
        ...
        updateText:function(n){
            n=u.isDefined(n)?n:"",this.applySettings({
                text:n
            })
        },
        _applyAttributes:function(n){
            this.callBase(n);
            var n=this.settings,d=this.settings.rotate,t=0,v,y,i=1,r=0,p,w=this.settings.y+(this.settings.translateY||0),b=this.settings.x+(this.settings.translateX||0),g=this.settings.align,k=this.getBBox(),c=this._style||{},f=0,e=0,u,a,l,o=k.width,s=k.height;
        ...
        ctor:function(n){
            n=n||{},n.animation={
                enabled:!1
            },document.namespaces&&!document.namespaces.vml&&(document.namespaces.add("vml","urn:schemas-microsoft-com:vml"),document.createStyleSheet().addRule(".vml","behavior: url(#default#VML); display: inline-block;")),this._clipRects={},this.callBase(n)
        },
        updateAnimationOptions:n.noop,
        recreateCanvas:function(n,t){
            var i=this,r;
            i.killContainer(),n>0&&t>0&&(i._size={
                width:n,
                height:t
            },r=new b(i,{
                width:n,
    ...
    u.Color=r.inherit(function(){
        var f=function(n){
            ...
            for(f in t)t.hasOwnProperty(f)&&r===f&&(r=t[f]);for(u=0;u<i.length;u++)if(s=i[u].re,o=s.exec(r),o){
    ...
    e.Range=o.inherit(function(){
        var y=function(t){
            ...
            if(u.invertY=u.invertY||r.invertY,u.stickY=u.stickY||r.stickY,u.keepValueMarginsY=u.keepValueMarginsY||r.keepValueMarginsY,t(u.minY,r.minY,function(n){
                ...
                u.maxVisibleY=n
            },o),c("minValueMarginY"),c("maxValueMarginY"),h===i)u.categoriesY=f;
            else if(f&&f.length)for(s=0;s<f.length;s++)n.inArray(f[s],h)===-1&&h.push(f[s]);
            return this
        },h=function(r){
            ...
            if(u.invertX=u.invertX||r.invertX,u.stickX=u.stickX||r.stickX,u.keepValueMarginsX=u.keepValueMarginsX||r.keepValueMarginsX,t(u.minX,r.minX,function(n){
                ...
                u.maxVisibleX=n
            },o),c("minValueMarginX"),c("maxValueMarginX"),h===i)u.categoriesX=f;
            else if(f&&f.length)for(s=0;s<f.length;s++)n.inArray(f[s],h)===-1&&h.push(f[s]);
            return this
        },w=function(){
            ...
            var i=(new Date).getYear()-1,r=t==="datetime"?new Date(i,0,1):0,u=t==="datetime"?new Date(i,11,31):10;
            n.extend(this,{
                minX:r,
                maxX:u,
                stubDataX:!0
            ...
            var n=this,t,i,u,f,e=r.isDate(n.maxX)||r.isDate(n.minX),o=r.isDate(n.maxY)||r.isDate(n.minY);
    ...
    r.Legend=u.inherit(function(){
        var t=function(t){
            ...
            var u=this,l=u.renderer,n=u.options,r=u.series||{},nt=0,tt=0,c=[],e,ot,b,rt,a,ut=n.markerSize,k=n.layout==="horizontal",s,v,t=n.columnCount,i=n.rowCount,h,d=u.legendGroup,f,g,st=n.equalColumnWidth,y=[],ft,p,o,it=!1,w=u.canvas,et=n.border.visible&&n.border.width&&n.border.color&&n.border.color!=="none";
            if(n.visible&&r&&r.length){
                ...
                }).append(f)),e=0;e<r.length;e++)a=l.createGroup({
                    "class":"dxLegendSeries"
                }),a.append(f),y.push(l.createRect(0,0,0,0,0,{
                    stroke:"none",
                    fill:"grey",
                    opacity:.0001
            ...
            var d=this,s,e,y,p,h,c,f,l=0,w=0,o,k=d.options,a=k.columnItemSpacing,v=k.rowItemSpacing,tt=k.equalColumnWidth,it=d.renderer,g=[],nt=0,b=0;
    ...
    var u=t.viz.charts,o=t.utils,f=t.Class,s=t.viz.core,r=t.formatHelper,e=f.inherit({
        ctor:function(n){
            this.renderer=n.renderer,this.options=n,this.style={
                visibility:"hidden"
            },this.customColor=n.color,this.textStyle={
                font:n.font,
                align:"center",
                visibility:"hidden"
        ...
        _getData:function(t,i,r){
            var y=4,l=t,a=i,h,v="center",u=[],c=[],s=this.options,f=s.arrowLength>0?s.arrowLength:0,o=r.width+s.paddingLeftRight*2,e=r.height+s.paddingTopBottom*2;
        ...
        _update:function(){
            var t,n;
            this.text.updateText(this.tooltipText),t=this.text.getBBox(),n=this._getData(this.x,this.y,t),this.shadow.applySettings({
                points:n.pointsOfShadow
                ...
                y:n.text.y
            }),t=this.text.getBBox(),this.text.applySettings({
                x:n.text.x,
        ...
        draw:function(){
            var n,t,i;
            this.tooltipGroup=this.renderer.createGroup({
                "class":"dxTooltip"
            }),n=this.renderer.createPath({},{
                fill:"#000000",
                stroke:"none",
                visibility:"hidden",
                opacity:.1
    ...
    f.ChartTitle=e.inherit({
        ...
        render:function(){
            var n=this,t=n.options,r=n.renderer,o=n.horizontalAlignment,f,u,s=n.clipRect?n.clipRect.id:i,h=r.createGroup({
                "class":"dxChartTitle",
                clipId:s
            }).append(),e=r.createGroup().append(h);
            t.text&&(f={
                font:t.font,
                align:o,
                style:t.fontStyle
    ...
    var a=t.viz.charts,w=t.viz.core,v=t.Class,r=t.utils,s=Math,c=100,y=5,p=2,h=4,l="canvas_position_",u="canvas_position_bottom",f="canvas_position_top",e="canvas_position_left",o="canvas_position_right";
    a.Axis=v.inherit(function(){
        var k=function(n,t){
            ...
            if(r&&r.getBoundRange&&!f.categories)for(i=n.getTickValues(),t=0;t<i.length-1;t++)u=Math.abs(i[t]-i[t+1]),f.isHorizontal?r.getBoundRange({
                intervalX:u
            }):r.getBoundRange({
                intervalY:u
            })
            ...
            if(u.isHorizontal&&t&&r.isDefined(t.overlappingBehavior)){
                switch(t.overlappingBehavior.mode){
                    case"enlargeTickInterval":case"stagger":
                        i=null;
                        break;
                    case"rotate":
            ...
            var i=this,u=i.options,o=u.tickProvider,a=i.translator,e=u.label,s=u.categories,h,f,c=u.isHorizontal?e.overlappingBehavior:null,l=u.isHorizontal?i.translator.translateX:i.translator.translateY;
            ...
            var a=t.isHorizontal?[e,o]:[u,f],v=Math.abs(i.call(n.translator,a[1])-i.call(n.translator,a[0])),y=r.getSignificantDigitPosition(Math.abs(t.max-t.min)/v),c,h=t.min,l=t.max;
            ...
            var u,f=n.options,k=f.categories,c=n.renderer,l=n.axisPosition,h=f.label,v=h.indentFromAxis,i,e,o,y=[],p=f.isHorizontal?c.createText:yt,b=f.isHorizontal?l+v:l-v,s;
            if(h.visible){
                if(i=a(n),i.length===0||i.hideLabels)return!0;
                for(u=0;u<i.length;u++)e=i[u],s=w(e.text,h),r.isDefined(s)&&s!==""&&(o=p.call(c,s,e.pos,b,n.textOptions),y.push(o),o.append(t),o.data({
                    argument:e.text
                }));
                n.labels=y
            }
            ...
            var s,o=n.options,f=n.renderer,e=n.axisPosition,i=o.title,h=i.margin,r,u={
                font:i.font,
                opacity:i.opacity,
                align:"center",
            ...
            var nt=n.renderer,g=n.options,p=g.grid,it=g.categories,l=n.translator,rt=g.discreteAxisDivisionMode==="crossLabels"?0:.5,y,a,tt={
                strokeWidth:p.width,
                stroke:p.color,
                strokeOpacity:p.opacity
            },ut,ft=n.axisPosition,w,b,c,k,d,r=r||{
                visible:!1
            };
            ...
            if(!tt.stubData){
                if(g=function(t,i,s,h){
                    var p=s?!!(h.minVisibleX||h.maxVisibleX):!!(h.minVisibleY||h.maxVisibleY),w=(s?h.categoriesX:h.categoriesY)||[],c=s?function(n){
                        return l.translateX(n)
                    }:function(n){
                        return l.translateY(n)
                    },k=s?!!h.invertX:h.invertY,a=s?[e,o]:[u,f],d,v=c(t),y=c(i),b=s?h.minVisibleX:h.maxVisibleY,g=s?h.maxVisibleX:h.maxVisibleY;
                    ...
                    for(p=l.translateY(u),w=l.translateY(f),a=0;a<k.length;a++)if(h=k[a],h.startValue!==i&&h.endValue!==i&&h.color!==i){
                        ...
                        v=nt.createRect(c.stripFrom,w,c.stripTo-c.stripFrom,p-w,0,{
                            fill:h.color
                        }),v.append(s),d.push(v),h.label&&h.label.text?y.push(b(t,h.label,c.stripFrom,c.stripTo,s)):y.push(null)
                    }
                    ...
                    v=nt.createRect(p,c.stripFrom,w-p,c.stripTo-c.stripFrom,0,{
                        fill:h.color
                    }),v.append(s),d.push(v),h.label&&h.label.text?y.push(b(t,h.label,c.stripFrom,c.stripTo,s)):y.push(null)
                }
            ...
            var c=n.renderer,l=t.text,f=n.translator.canvas,e={
                align:n.options.isHorizontal?"center":"left",
                font:t.font||n.options.label.font
            },h,o,s;
            ...
            if(r.label.visible&&u&&u.length){
                for(t=0;t<u.length;t++)i=u[t],f=i.getBBox(),r.isHorizontal&&r.position==="bottom"?i.applySettings({
                    y:2*i.settings.y-f.y
                }):r.isHorizontal||r.position!=="left"&&r.position!=="right"?r.isHorizontal&&r.position==="top"&&i.applySettings({
                    y:2*i.settings.y-f.y-f.height
                }):i.applySettings({
                    y:i.settings.y+~~(i.settings.y-f.y-f.height/2)
                });
                if(o=ni(n,u),o){
            ...
            var t=this,s=t.options.isHorizontal?"h-axis":"v-axis",h=t.options.isHorizontal?"h-strips":"v-strips",c=t.clipRectID&&t.options.placeholderSize?t.clipRectID:i,r=t.axisGroup=t.axisGroup||t.renderer.createGroup({
                "class":s,
                clipId:c
            }),u=t.axisStripGroup=t.axisStripGroup||t.renderer.createGroup({
                "class":h
            }),o=t.renderer.createGroup({
                "class":"axis-grid"
            }),f=t.renderer.createGroup({
                "class":"axis-elements"
            }),e=t.renderer.createGroup({
                "class":"axis-line"
            });
            ...
            var n=this.axisElementsGroup.getBBox(),f=this.axisLineGroup.getBBox(),e=this.options.placeholderSize,t,u=this.options.isHorizontal,i=u&&"y"||"x",r=u&&"height"||"width",o=this.options.position===(u&&"bottom"||"right");
    ...
    var f=t.ui,e=f.Component,u=t.viz.charts,r=t.utils,s=100,o={
        animate:!1
    };
    ...
    u.BaseChart=e.inherit({
        ...
        _processAxesOption:function(t){
            var u=n.isArray(t.argumentAxis)?t.argumentAxis:[t.argumentAxis],f=n.isArray(t.valueAxis)?t.valueAxis:[t.valueAxis],i=function(n){
                for(var t,u,i=0,i=0;i<n.length;i++)t=n[i],t&&t.title&&r.isString(t.title)&&(u=t.title,t.title={},t.title.text=u),t&&t.label&&(t.label.alignment&&(t.label.userAlignment=!0),r.isString(t.label.overlappingBehavior)&&(t.label.overlappingBehavior={
                    mode:t.label.overlappingBehavior
                }),t.label.overlappingBehavior&&t.label.overlappingBehavior.mode||(t.label.overlappingBehavior=t.label.overlappingBehavior||{},t.label.rotationAngle&&(t.label.overlappingBehavior.mode="rotate",t.label.overlappingBehavior.rotationAngle||(t.label.overlappingBehavior.rotationAngle=t.label.rotationAngle)),t.label.staggered&&(t.label.overlappingBehavior.mode="stagger",t.label.overlappingBehavior.staggeringSpacing||(t.label.overlappingBehavior.staggeringSpacing=t.label.staggeringSpacing))))
            };
        ...
        createRenderer:function(){
            ...
            return n=n===!0?this._defaultOptions().animation:n,u.factory.createRenderer({
                animation:n
            })
        },
        _createThemeManager:function(n){
            return n=n||{},u.factory.createThemeManager({
                theme:n.theme,
                palette:n.palette
            })
        },
        ...
        _render:function(n){
            var t=this,r=t.renderer,f=t.translators,o=t.layoutManager,i=t.canvas,s=t._element(),e=t._calculateCanvas(),u=t.dirtyCanvas;
            if(n=n||{
                recreateCanvas:!0
            },n.recreateCanvas=n.recreateCanvas||!r.isInitialized(),!n.force&&u&&u.width===e.width&&u.height===e.height){
                t.stopRedraw=!0;
                return
            }
            if(clearTimeout(t.delayedRedraw),n.recreateCanvas&&(r.killContainer(),i=t._calculateCanvas()),i.width&&i.height&&s.is(":visible"))t.hiddenContainer=!1;
            else{
        ...
        _optionChanged:function(n,t,i){
            var r;
            if(n==="dataSource")this._reinitDataSource(),this._needHandleRenderComplete=!0;
            else if(n==="series")this.series=this._populateSeries(),this._handleDataSourceChanged(),this._needHandleRenderComplete=!0;
            else if(n==="commonSeriesSettings")this.option("userCommonSeriesSettings",t),this.series=this._populateSeries();
            else if(n==="commonAxisSettings")this.option("userCommonAxisSettings",t);
            else if(n==="palette"||n==="theme")this.themeManager=this._createThemeManager({
                palette:t,
                theme:this._options.theme
            }),this.option(this.themeManager.applyChartTheme(this._options));
            else if(n==="animation")this.renderer.updateAnimationOptions(t);
            else if(n==="panes"||n==="valueAxis"||n==="argumentAxis")this._panesChanged=!0,this._needReinit=!0,this._needHandleRenderComplete=!0,this.callBase.apply(this,arguments);
            else if(n==="title"){
        ...
        _refresh:function(){
            this._needReinit&&this._reinit(),this._needReinit=!1,this._clean(),this._render({
                force:!0
            })
        },
        ...
        _processSeriesTemplate:function(){
            var f=this,o=this.option("seriesTemplate"),y=r.isFunction(o.customizeSeries)?o.customizeSeries:n.noop,s=o.nameField||"series",c=this._dataSource,e,v,u;
            if(c){
                var h={},l=[],a=c.items(),i;
    ...
    r.Chart=r.BaseChart.inherit({
        ...
        _populateBusinessRange:function(t){
            var u=this,tt=u.panes,a=[],ft,o,l=u.option("rotated"),v,c=l?u.horizontalAxes:u.verticalAxes,p=l?u.verticalAxes:u.horizontalAxes,y=l&&"X"||"Y",h=l&&"Y"||"X",w="getBoundRange"+y,b="getBoundRange"+h,et,it=n.map(tt,function(n){
                return n.name
        ...
        _populateSeries:function(){
            var i=this,tt=!!i.option("seriesTemplate"),s=tt?i._templatedSeries:i.option("series"),v=n.isArray(s)?s:s?[s]:[],h=i.option("argumentAxis"),f=i.option("valueAxis"),y=i.themeManager,l,t,p=i.option("commonSeriesSettings"),it=i.option("userCommonSeriesSettings"),e,w=i.renderer.createGroup({
                "class":"series-container"
            }),b=i.renderer.createGroup({
                "class":"labels-container"
            }),k=i.renderer.createGroup({
                "class":"tracker",
                opacity:.0001
            }),d=i.renderer.createGroup({
                "class":"seriesTracker"
            }),g=i.renderer.createGroup({
                "class":"markerTracker",
                stroke:"none",
                fill:"grey"
        ...
        _populateAxes:function(){
            var t=this,o=[],h=[],u=t.panes,f=t.option("rotated"),tt=t.themeManager,c=t.option("valueAxis")||{},l=t.option("argumentAxis")||{},a=n.isArray(l)?l:[l],w=n.isArray(c)?c:[c],it,e,y=[],rt,p=r.factory.getAxisTickProvider(),v,b=function(i,u){
                i=n.extend(!0,{
                    isHorizontal:!f,
                    tickProvider:p,
                    pane:t.defaultPane,
        ...
        _render:function(t){
            if(this._seriesInitializing!==!0){
                var i=this,b=i.renderer,e=i.translators,h=i.option("rotated"),u,f=i.layoutManager,p=i.option("title"),c=0,l,w=new r.MultiAxesSynchronizer,s=i._createPanesBorderOptions(),a=i.stripsGroup=i.stripsGroup||i.renderer.createGroup({
                    "class":"axis-strips"
                }),v=function(n,t){
                    var r,f,i,e;
                ...
                do{
                    ...
                    for(i.option("synchronizeMultiAxes")&&w.synchronize(h?i.horizontalAxes:i.verticalAxes,h),u=0;u<i.horizontalAxes.length;u++)i.horizontalAxes[u].clipRectID=i._getCanvasClipRectID(),i.horizontalAxes[u].stripsGroup=a,i.horizontalAxes[u].draw({
                        borderOptions:s[i.horizontalAxes[u].pane]
                    });
                    for(f.requireAxesRedraw=!1,t.adjustAxes&&(f.applyHorizontalAxesLayout(),n.each(e,function(n,t){
                        t.init()
                    })),u=0;u<i.verticalAxes.length;u++)i.verticalAxes[u].clipRectID=i._getCanvasClipRectID(),i.verticalAxes[u].stripsGroup=a,i.verticalAxes[u].draw({
                        borderOptions:s[i.verticalAxes[u].pane]
                    });
        ...
        _setPanesClipRectPadding:function(t,i){
            var r=this,u=!0,o=t[r.panes[0].name].visible,s=t[r.panes[r.panes.length-1].name].visible,f="",e;
        ...
        _createPanesBackground:function(){
            for(var n=this,e=n.option("commonPaneSettings").backgroundColor,t,u,o=n.renderer,f,r=[],i=0;i<n.panes.length;i++){
                ...
                u={
                    fill:t,
                    strokeWidth:0
                },f=o.createRect(0,0,0,0,0,u).append(),r.push(f)
            }
            n.panesBackground=r
        },
        ...
        _drawPanesBorders:function(t){
            var i=this,f=i.option("rotated"),u=i.renderer,r=i.borderGroup=i.borderGroup||u.createGroup({
                "class":"dxBorder"
            });
        ...
        _createClipRectsForPanes:function(){
            ...
            t.minClipRectID=[],t.maxClipRectID=[],n.each(t.panes,function(u,f){
                var c=n.extend({},r,f.border),e=f.borderCoords,s,h,o=!c.visible&&t.paneClipRectPadding||0;
        ...
        _handleSeriesPopulated:function(n){
            this._processSeriesFamilies(),this._createLegend(),this._populateBusinessRange(),this._processValueAxisFormat(),this._processTracker(),delete this._seriesInitializing,n&&this._render({
                force:!0
            })
        },
    ...
    r.PieChart=r.BaseChart.inherit({
        ...
        _populateBusinessRange:function(){
            ...
            t&&(n=new r.Range({
                series:t
            }),f=t.getRangeData(),n=n.getBoundRange(f),n.isDefined()||n.setStubData(),u.push(n)),i.businessRanges=u
        },
        _createTranslator:function(n){
            return new DevExpress.viz.core.Translator1D(n.minY,n.maxY,360-.0001,0)
        },
        _populateSeries:function(){
            var t=this,d=!!t.option("seriesTemplate"),o=d?t._templatedSeries:t.option("series"),l=n.isArray(o)?o:o?[o]:[],a=t.themeManager,h,f,e,s,c,g=t.option("commonSeriesSettings"),nt=t.option("userCommonSeriesSettings"),v=t.renderer.createGroup({
                "class":"series"
            }),y=t.renderer.createGroup({
                "class":"tracker",
                opacity:.0001
            }),p=t.renderer.createGroup({
                "class":"seriesTracker"
            }),w=t.renderer.createGroup({
                "class":"markerTracker",
                stroke:"none",
                fill:"grey"
            }),b=t.renderer.createGroup({
                "class":"labels"
    ...
    var o=t.viz,u=o.core,r=t.viz.charts,s=t.Class,f=t.utils,h=120,e=20,c=20,l=20,a=30,v=20;
    r.ThemeManager=u.BaseThemeManager.inherit(function(){
        var t=function(n,t){
            ...
            var c=this,f=n.extend(!0,{},i||c.theme.commonSeriesSettings),s=n.extend(!0,{},u||{}),h=(t.type||f.type||"").toLowerCase(),l=~h.indexOf("area")||~h.indexOf("bar"),o;
            ...
            var e=this,o=i||e.theme.commonSeriesSettings||{},u=n.extend(!0,{},o.pie),s=t.type||u.type||"",f;
    ...
    e.LayoutManager=o.inherit(function(){
        var v=function(n){
            ...
            var f=this,n=f.canvas,e=15,t=f.chart.chartTitle,i,u,o=t.innerTitleGroup.settings.translateY||0;
            ...
            var o=this,i=o.canvas,a=o.legend,e=o.legend.options,f=a.getBoundingRect(),c=10,l=10,s,h,v=o.chart.chartTitle;
            ...
            var s=this,i=s.canvas,c=s.chart.series,n=c[0]||{},f=i.height-i.top-i.bottom,e=i.width-i.left-i.right,h=e<f?e:f,o,l=n.outerRadius,t=n.type==="pie"?0:n.innerRadius||0;
    ...
    var u=t.viz.charts.series,h=u.consts.events,i=u.consts.states,r=t.utils,o=t.Class,c=t.viz.core,f=t.formatHelper,e="canvas_position_default",s=o.inherit({
        ctor:function(n){
        ...
        drawTrackerMarker:function(n,t){
            if(this.hasValue()){
                var i=this,u=i.options,r=n.createCircle(i.x,i.y,u.trackerR||i.storeTrackerR(),i._trackerAttrs);
                r.append(t),r.data({
                    point:i
                })
            }
        ...
        _populatePointShape:function(n,t){
            ...
            i.options.symbol==="square"&&(n.points=[{
                ...
                x:i.x-t,
                y:i.y-t
            }]),i.options.symbol==="cross"&&(n.points=[{
                x:i.x-t,
                y:i.y-r
            },{
                x:i.x-r,
    ...
    var r=t.viz.charts.series,i=r.consts.states,f=r.BasePoint,u="canvas_position_default",e=f.inherit({
        ...
        drawTrackerMarker:function(n,t){
            ...
            if(this.hasValue()){
                ...
                i.rotated?u===1&&(u=9,o-=4):r===1&&(r=9,e-=4),s=i.options,f=n.createRect(o,e,u,r,s.attributes.r,this._trackerAttrs),f.append(t),f.data({
                    point:this
                })
            }
        },
    ...
    var u=t.viz.charts.series,f=t.utils,s=t.viz.core,e=u.BasePoint,r=u.consts.states,i=t.formatHelper,o=e.inherit({
        ctor:function(n){
        ...
        translate:function(n){
            ...
            if(this.translator=n=n||this.translator,this.translator&&this.hasValue()){
                var u=n[t](this.openValue),f=n[t](this.highValue),e=n[t](this.lowValue),o=n[t](this.closeValue),s=n[r](this.argument);
        ...
        drawTrackerMarker:function(n,t){
            if(this.hasValue()){
                ...
                r===u&&(r=e?r+2:r-2,u=e?u-2:u+2),s=o.abs(u-r),f=e?n.createRect(o.min(u,r),i.x-i.width/2,s,i.width,0,this._trackerAttrs):n.createRect(i.x-i.width/2,o.min(u,r),i.width,s,0,this._trackerAttrs),f.append(t),f.data({
                    point:this
                })
            }
        },
        ...
        getTooltipFormatObject:function(t){
            ...
            },t.options),u=t.formatValueTooltip.call({
    ...
    var i=t.viz.charts.series,r=t.utils,o=i.consts.events,u=i.consts.states,f=i.BasePoint,e=f.inherit({
        ...
        _populatePointShape:function(n,t){
            ...
            this.rotated?(i=Math.max(e.x,e.minX),u=Math.min(e.x,e.minX),r=f=e.y):(i=u=e.x,r=Math.min(e.y,e.minY),f=Math.max(e.y,e.minY)),e.options.symbol==="square"&&(n.topPoints=[{
                ...
                x:u-t,
                y:f-t
            }]),e.options.symbol==="polygon"&&(n.topPoints=[{
                x:i-t,
                y:r
            },{
                x:i,
                ...
                x:u-t,
                y:f
            }]),e.options.symbol==="triangle"&&(n.topPoints=[{
                x:i-t,
                y:r-t
            },{
                x:i+t,
                ...
                x:u-t,
                y:f-t
            }]),e.options.symbol==="cross"&&(n.topPoints=[{
                x:i-t,
                y:r-t/2
            },{
                x:i-t/2,
        ...
        drawTrackerMarker:function(n,t){
            ...
            if(this.hasValue()){
                ...
                this.rotated?(u=Math.min(this.x,this.minX)-i,f=this.y-i):(u=this.x-i,f=Math.min(this.y,this.minY)-i),e=n.createRect(u,f,r.width+2*i,r.height+2*i,0,r._trackerAttrs),e.append(t),e.data({
                    point:this
                })
            }
        },
    ...
    var e=t.viz.charts.series,o=e.consts.events,i=e.consts.states,r=t.utils,v=t.Class,y=t.viz.core.ParseUtils,s=20,h=15,c=.3,f="allseriespoints",u="includepoints",l=0,a=1,p=20,w=v.inherit({
        ...
        _checkValue:function(n){
            ...
            if(r.isString(n.value))n.axisType="discrete",n.type="string";
            else if(r.isDate(n.value))n.axisType=n.axisType||"continuous",n.type="datetime";
            else if(r.isNumber(n.value))n.axisType=n.axisType||"continuous",n.type="numeric";else return this._validationResult.error=this._errorMessages.unsupportedFieldMessage(n.field),this.options.incidentOccured.call(null,this._errorMessages.unsupportedFieldMessage(n.field)),!1;
            return!0
        },
        ...
        getRangeData:function(t){
            ...
            var f=this,e=f.options,p=e.argumentCategories,l=e.argumentAxisType==="discrete",w=e.argumentType,b=e.valueCategories,a=e.valueAxisType==="discrete",k=e.valueType,i={
                visibleValCategories:[],
                categoriesVal:[],
                categoriesArg:[]
            },u=f.points,v=u&&u.length,o,d,g;
        ...
        draw:function(t){
            var c={
                ...
                "class":"series-elements"
            },f=n.extend({
                "class":"series-markers"
            },this.styles.point.states.normal),e={
                "class":"labels"
            },r,o,s,h;
            if(t){
        ...
        select:function(){
            this.seriesGroup&&this.seriesGroup.trigger(new n.Event(o.selectSeries,{
                target:this
            }),this.options.selectionMode),this.seriesGroup&&this.seriesGroup.toForeground(),this.trackerElements&&this.trackerElements.length&&n.each(this.trackerElements,function(n,t){
                t.toBackground()
            })
        },
        clearSelection:function(){
            this.seriesGroup&&this.seriesGroup.trigger(new n.Event(o.deselectSeries,{
                target:this
        ...
        _checkInputData:function(t,i,r){
            this._validationResult={
                error:null
            },this._parseUtils=new y({
                incidentOccured:this.options.incidentOccured
            });
        ...
        _checkArgumentAxisParams:function(n,t){
            var r=this,i=r.options,o=r._parsedUserOptions,l=o.argumentCategories,u=r._correctAxisType(o.argumentAxisType,o.argumentCategories),e=r._parseUtils.correctValueType(o.argumentType),s,c,h,f={};

            t=t||i.argumentField||"arg",i.userArgumentType=e,i.userArgumentAxisType=u;
            switch(e.toLowerCase()){
                case"numeric":case"datetime":
        ...
        _checkValueAxisParams:function(t,i){
            var u=this,r=u.options,c=u._parsedUserOptions,y=r.valueField||"val",p=r.rangeValue1Field||"val1",w=r.rangeValue2Field||"val2",b=c.valueCategories,e=u._correctAxisType(c.valueAxisType,c.valueCategories),s=u._parseUtils.correctValueType(c.valueType),f,h,l={},k,d,a,o={},g,v;
            ...
            for(f=0;f<i.length;f++)if(o.value=l[i[f]],o.field=i[f],!u._checkValue(o))return;r.valueAxisType=o.axisType,r.valueType=o.type
        },
        _prepareInputData:function(i,u,f){
            ...
            var o=this,e=o.options,h=e.argumentCategories,l=e.argumentAxisType,y=e.argumentType,c=o._errorMessages,a=o.options.incidentOccured,p=e.valueField||"val",w=e.rangeValue1Field||"val1",b=e.rangeValue2Field||"val2",ot=e.valueCategories,st=e.valueAxisType,k=e.userValueType,d=e.userArgumentType,g=e.userValueAxisType,nt=e.userArgumentAxisType,tt=e.valueType,it=e.tagField||"tag",ht=t.data.query,ct=n.noop,lt=n.noop,s=[];
            ...
            return s=n.map(i,function(n){
                var o=nt==="discrete"&&!d?n[u]:ft(n[u]),i={
                    tag:n[it]
                },e,t;
        ...
        _parseInputData:function(n){
            var t=this,a=e.pointFactory.createPoint,v=t.options.rotated,y=t.styles.point,u,f=0,i,r,h,c,l,o=t.options,s=s||o.argumentField||"arg",p=o.tagField||"tag";
        ...
        parseStyleOptions:function(t){
            ...
            return{
                ...
                reduction:{
                    color:i.reduction.color,
                    level:i.reduction.level,
    ...
    var i=t.viz.charts.series,f=i.consts.events,r=i.BaseSeries,u=r.inherit({
        ...
        drawTrackers:function(){
            ...
            if(t.callBase(),t.preparedSegments||(t.preparedSegments=[],n.each(t.segments,function(n){
                ...
                t.trackerElements.push(u),u.data({
                    series:t
                })
            }),this
        },
        ...
        drawTrackers:function(){
            ...
            if(!this._suppressTrackers)return t.drawPointTrackers(),t.trackerElements=[],n.each(this.areaSegments,function(n,i){
                ...
                r=i.length===2?t.drawSegment(i,{
                    ...
                    fill:"grey",
                    opacity:.0001
                }).append(t.options.seriesTrackerGroup),t.trackerElements.push(r),r.data({
                    series:t
                })
            }),i
        },
    ...
    var i=t.viz.charts.series,r=t.utils.isDefined,u=i.BaseSeries,f=u.inherit({
        ...
        getRangeData:function(){
            var t=this,e=t.options,o=e.rotated,s=o?"X":"Y",f=o?"Y":"X",i=[],u=[],h=function(n,t){
                return n-t
            };
        ...
        _parseInputData:function(t){
            var o=this,r,y=i.pointFactory,c=this.options.argumentField||"date",f=this.options.openValueField||"open",s=this.options.highValueField||"high",h=this.options.lowValueField||"low",e=this.options.closeValueField||"close",b=this.options.tagField||"tag",p=this.styles.point,a=this.styles.reduction.color,w=this.styles.reduction.innerColor,v,l,u;
    ...
    var i=t.viz.charts.series,r=i.SplineSeries,u=r.inherit({
        ...
        adjustOptions:function(){
            var t=this.styles,i=t.attributes,r=t.states,o=r.hover,s=r.selected,h=r.normal,u={},f={},e={},n;
    ...
    var u=t.viz.charts.series,o=t.viz.core,r=u.consts.states,f=u.BasePoint,i=Math.round,e=f.inherit({
        ...
        correctLabelPosition:function(){
            var e=this.label.getBBox(),o=this.options.label,n=t.utils.getCosAndSin(this.middleAngle),u="center",r=this.radiusOuter+o.radialOffset,f,s;
            switch(o.position){
                case"outside":
        ...
        correctConnectorPosition:function(){
            if(this.options.label.position!=="inside"&&this.connector){
                var r=t.utils.getCosAndSin(i(this.middleAngle)),s=this.series.styles.attributes,c=this.series.userOptions.containerBackgroundColor===s.stroke?~~(s.strokeWidth/2):~~(-s.strokeWidth/2),f=this.radiusOuter,l=i(this.centerX+(f-c)*r.cos),a=i(this.centerY-(f-c)*r.sin),h,u,e,v,n,o=this.options.label,y;
                h=i(this.centerX+(f+o.radialOffset+this.CONNECTOR_LENGTH)*r.cos),o.position==="outside"&&(u=i(this.centerY-(f+o.radialOffset+this.CONNECTOR_LENGTH)*r.sin),this.connector.applySettings({
                    points:[l,a,h,u]
                })),o.position==="columns"&&(n=this.insideLabelGroup.getBBox(),n.x=n.x+(this.insideLabelGroup.settings.translateX||0),n.y=n.y+(this.insideLabelGroup.settings.translateY||0),u=n.y+n.height/2,this.labelBackground?e=n.x+n.width/2:r.cos<0?e=n.x+n.width:r.cos>0&&(e=n.x),v=u,this.connector.applySettings({
                    points:[{
                        x:l,
                        y:a
                    },{
        ...
        rotateLabel:function(){
            var i=this.options.label,f=this.radiusOuter+i.radialOffset,e=t.utils.getCosAndSin(this.middleAngle),r,u,n=this.insideLabelGroup.getBBox();
            switch(i.position){
                case"outside":
        ...
        checkEllipsis:function(){
            var r=this,c,s=10,i,a,b=0,v=[],k=[],d,o,y,f,l,e,h=t.utils.getCosAndSin(r.options.label.rotationAngle),u=r.series.canvas,g=this.options.label,p=t.utils.getCosAndSin(this.middleAngle),w=this.centerX+(this.radiusOuter+this.CONNECTOR_LENGTH)*p.cos;
    ...
    var i=t.viz.charts.series,r=i.BaseSeries,u=20,f=80,e=r.inherit({
        ...
        arrangePoints:function(){
            var i=this,t,f,u=0,h=this.translator,e=0,o,r,s=i.options.segmentsDirection!=="anticlockwise";
        ...
        var f=function(i){
            ...
            n.each(t,function(t,r){
                ...
                n.each(u,function(n,t){
                    var s=t.value,f=r.getStackName?r.getStackName():"default",e=s>=0?"positive":"negative",o;
    ...
    var s=t.viz.charts,i=s.series.consts.events,h=t.utils,c=t.Class,u="multiple",f="single",r="allargumentpoints",e="allseriespoints",p=window.navigator.msPointerEnabled&&window.navigator.msMaxTouchPoints,l=1e3,a=600,v=400,o="none",y=c.inherit({
        ctor:function(n){
        ...
        _prepare:function(){
            ...
            }),t._eventHandler("seriesTrackerGroup",{
                tracker:t
            },"series"),t._eventHandler("legendGroup",{
                tracker:t
            },"series"),t._eventHandler("markerTrackerGroup",{
                tracker:t
            },"point");
            t.seriesGroup.on(i.selectSeries,{
                tracker:t
            },t._selectSeries);
            t.seriesGroup.on(i.deselectSeries,{
                tracker:t
            },t._deselectSeries);
            t.seriesGroup.on(i.selectPoint,{
                tracker:t
            },t._selectPoint);
            t.seriesGroup.on(i.deselectPoint,{
                tracker:t
            },t._deselectPoint)
        },
        ...
        _seriesMouseOver:function(t){
            if(n(t.target).data("series")){
                var i=t.data.tracker,u=n(t.target).data("series"),r=n(t.target).data("mode")||u.options.hoverMode,f=function(n,t){
    ...
    var e=n.viz.gauges,h=n.viz.renderers,i=e.__internals,u=i.circularNeedles,o=i.circularMarkers,f=i.linearNeedles,s=i.linearMarkers,r=n.utils.isString;
    e.__factory={
    ...
    var p=n.formatHelper,c=n.utils.getCosAndSin,l=n.utils.normalizeAngle,w=n.utils.convertAngleToRendererSpace,a=n.utils.isDefined,v=n.utils.isString,b=n.utils.isFunction,e=n.utils.isArray,k=window.isNaN,r=window.Number,d=window.String,o=Math.max,ut=Math.min,u=Math.abs,g=Math.atan,nt=Math.acos,y=Math.ceil,tt=t.extend,f=t.map,s=Math.PI,it=n.viz.core.tickProvider;
    n.viz.gauges.__internals.BaseScale=n.Class.inherit({
        ...
        _getTicks:function(){
            var u=this,n=u._options,s=n.translator,y=s.getDomainStart(),p=s.getDomainEnd(),l=y<p?function(n,t){
                return n-t
            }:function(n,t){
                return t-n
        ...
        render:function(){
            var n=this,t;
            return n._rootElement||(n._rootElement=n._renderer.createGroup({
                "class":"scale"
            }),n._majorTicks=n._renderer.createGroup({
                "class":"dx-major-ticks"
            }).append(n._rootElement),n._minorTicks=n._renderer.createGroup({
                "class":"dx-minor-ticks"
            }).append(n._rootElement),n._labels=n._renderer.createGroup({
                "class":"labels"
            }).append(n._rootElement)),n._rootElement.append(n._owner),n._majorTicks.clear(),n._minorTicks.clear(),n._labels.clear(),n._processOptions(),n._isVisible()?(t=n._getTicks(),n._renderContent(t)):n._rootElement&&(n._rootElement.remove(),delete n._rootElement,delete n._majorTicks,delete n._minorTicks,delete n._labels),n
        },
        _formatValue:function(n){
            var i=this._options.label,t=p.format(n,i.format,i.precision);
            return b(i.customizeText)&&(t={
                value:n,
                valueText:t
            },t=d(i.customizeText.call(t,t))),t
        },
        _getSampleText:function(){
            var n=this,t=n._formatValue(n._options.translator.getDomainStart()),i=n._formatValue(n._options.translator.getDomainEnd());
            return t.length>=i.length?t:i
        },
        _measureText:function(){
            var n=this,i=n._renderer.createGroup({
                "class":"scale"
            }).append(n._rootElement),u=n._renderer.createGroup({
                "class":"labels"
            }).append(i),r=n._getSampleText(),f=n._renderer.createText(r,0,0,{
                "class":"dx-gauge-scale-label",
                align:"center",
        ...
        _getCuttingFactor:function(n,t){
            var i=this,w=i._options,b=w.translator.getCodomainStart(),k=w.translator.getCodomainEnd(),f=i._getLabelPosition(i._majorTickLength||0,i._textIndent),e=rt(l(b),l(k)),h=c(e),d=(b-k)/n,a,v,tt,p,r,it=1;
        ...
        _getCuttingFactor:function(n,t){
            var i=this._options,r=this._vertical?t.height:t.width,f=u(i.translator.getCodomainEnd()-i.translator.getCodomainStart());
    ...
    var r=n.formatHelper,u=n.utils.isFunction,f=window.isFinite,s=window.Number,e=window.String,o=t.extend;
    n.viz.gauges.__internals.BaseIndicator=n.viz.gauges.__internals.BaseGaugeItem.inherit({
        ...
        _formatValue:function(n){
            var t=this._options.text,i=r.format(n,t.format,t.precision),f={
                value:n,
                valueText:i
            };
        ...
        _runAnimation:function(n,t){
            var i=this;
            i._isCurrentValueLocked=!0,i._animateStart=n,i._animateDelta=t-n,i._rootElement.animate({
                fake:!0
            },{
    ...
    n.viz.gauges.__internals.BaseTextCloudMarker=n.viz.gauges.__internals.BaseIndicator.inherit({
        _updateActiveElements:function(){
            ...
            n._text.applySettings({
                text:n._formatValue(n._actualValue)
            }),i=n._text.getBBox(),t.setup({
                x:u.x,
                y:u.y,
                textWidth:i.width,
                textHeight:i.height,
        ...
        _measureText:function(){
            var n=this,t;
            n._rootElement=n._rootElement||n._renderer.createGroup({
                "class":"marker"
            }),n._rootElement.append(n._owner),n._cloud=n._cloud||n._renderer.createArea().append(n._rootElement),n._text=n._text||n._renderer.createText().append(n._rootElement),n._text.applySettings({
                x:0,
                y:0,
                align:"center",
    ...
    n.viz.gauges.__internals.BaseRangeBar=n.viz.gauges.__internals.BaseIndicator.inherit({
        _prepare:function(){
            var n=this,t;
            n._hasText=n._isTextVisible(),n._hasText&&(n._rootElement=n._rootElement||n._renderer.createGroup({
                "class":"rangebar"
            }).append(n._owner),n._text=n._text||n._renderer.createText().append(n._rootElement),n._text.applySettings({
                x:0,
                y:0,
    ...
    r.SimpleIndicator=n.viz.gauges.__internals.BaseIndicator.inherit({
        ...
        _getTrackerPoints:function(){
            var n=this._options,i=n.y-n.radius,r=n.y-n.indentFromCenter||n.y,t=n.x-n.width/2||n.x,u=t+n.width||n.x;
        ...
        render:function(){
            var n=this;
            return n.callBase(),n._isVisible()?(n._rootElement=n._rootElement||n._renderer.createGroup({
                "class":n._getClassName()
            }),n._rootElement.append(n._owner),n._create(),n._tracker=n._tracker||n._renderer.createArea().append(n._trackerOwner),n._tracker.applySettings({
        ...
        getTooltipParameters:function(){
            var t=this._options,i=n.utils.getCosAndSin(this._getActualPosition()),r=(t.radius+t.indentFromCenter)/2;
            return{
                x:t.x+i.cos*r,
                y:t.y-i.sin*r,
    ...
    r.SimpleIndicator=n.viz.gauges.__internals.BaseIndicator.inherit({
        ...
        render:function(){
            var n=this;
            return n.callBase(),n._isVisible()?(n._zeroPosition=n._options.translator.getCodomainStart(),n._rootElement=n._rootElement||n._renderer.createGroup({
                "class":n._getClassName()
            }),n._rootElement.append(n._owner),n._create(),n._tracker=n._tracker||n._renderer.createArea().append(n._trackerOwner),n._tracker.applySettings({
                points:n._getTrackerPoints(),
                stroke:"none",
        ...
        getTooltipParameters:function(){
            var n=this,t=n._options,r=n._getActualPosition(),i={
                x:r,
                y:r,
    ...
    var i=n.viz.gauges.__internals.circularMarkers,r=n.utils.normalizeAngle,e=n.utils.convertAngleToRendererSpace,u=n.utils.getCosAndSin,f=Math.min;
    i.TriangleMarker=n.viz.gauges.__internals.circularNeedles.SimpleIndicator.inherit({
        ...
        _create:function(){
            ...
            t._element=t._element||t._renderer.createArea([],{
                "class":"dx-marker-element"
            }).append(t._rootElement),i={
        ...
        _getTrackerPoints:function(){
            var n=this._options,i=n.x-n.width/2,r=n.x+n.width/2,t=n.y-n.radius,u=t-n.length||t;
        ...
        getTooltipParameters:function(){
            var t=this._options,r=n.utils.getCosAndSin(this._getActualPosition()),u=t.radius+t.length/2,i=this.callBase();
    ...
    r.TriangleMarker=n.viz.gauges.__internals.linearNeedles.SimpleIndicator.inherit({
        ...
        _create:function(){
            var t=this,n=t._options,i,e,r,o,f={
                stroke:"none",
                strokeWidth:0,
                fill:n.color
            };
    ...
    n.viz.gauges.__internals.CircularRangeBar=n.viz.gauges.__internals.BaseRangeBar.inherit({
        ...
        _updateTextPosition:function(){
            var n=this,t=i(n._getActualPosition()),r=n._options.x+n._textRadius*t.cos,u=n._options.y-n._textRadius*t.sin;
        ...
        _updateLinePosition:function(){
            ...
            n._basePosition>f?(i=t-2,u=t):n._basePosition<f?(i=t,u=t+2):(i=t-1,u=t+1),n._line.applySettings({
                points:[i,n._lineFrom,i,n._lineTo,u,n._lineTo,u,n._lineFrom]
            }),n._line.rotate(e,t,n._options.y)
        },
        measure:function(){
    ...
    n.viz.gauges.__internals.LinearRangeBar=n.viz.gauges.__internals.BaseRangeBar.inherit({
        ...
        _getPositions:function(){
            var i=this,c=i._options,s=i._startPosition,h=i._endPosition,f=i._space,r=i._basePosition,u=i._getActualPosition(),n,t,e,o;
    ...
    n.viz.gauges.__internals.CircularSpindle=n.Class.inherit({
        ...
        render:function(){
            var n=this,t=n._options;
            return t.visible!==!1&&t.size>0?(n._rootElement=n._rootElement||n._renderer.createGroup({
                "class":"spindle"
            }),n._rootElement.append(n._owner),n._element=n._element||n._renderer.createCircle().append(n._rootElement),n._element.applySettings({
        ...
        measure:function(){
            ...
            return{
                inverseHorizontalOffset:n,
                inverseVerticalOffset:n
            }
        }
    })
}(DevExpress,jQuery),function(n,t){
    ...
    var h=n.utils.isDefined,e=n.utils.isString,o=n.utils.isArray,u=window.Number,s=window.isFinite,f=Math.max,c=Math.abs,r=t.each,l=t.map,a=t.extend;
    n.viz.gauges.__internals.BaseRangeContainer=n.Class.inherit({
        ...
        _getRanges:function(){
            var n=this._options,t=n.translator,k=t.getDomainStart(),tt=t.getDomainEnd(),a=tt-k,et=a>=0?p:w,it=a>=0?v:y,d=[],i=[],g=[{
                start:k,
                end:tt
            }],ot=c(a)/1e4,rt=o(n.palette)?n.palette:[],ut,st=e(n.backgroundColor)?n.backgroundColor:"none",h=n.width||{},b=u(h>0?h:h.start),nt=u(h>0?h:h.end),ft=nt-b;
            return n.ranges?b>=0&&nt>=0&&b+nt>0?(d=l(n.ranges,function(n){
                n=n||{};

                var i=t.adjust(n.startValue),r=t.adjust(n.endValue);
                return s(i)&&s(r)&&et(i,r,ot)?{
                    start:i,
                    end:r,
                    color:n.color
                }:null
        ...
        render:function(){
            ...
            }),n._rootElement.append(n._owner).clear(),t=n._getRanges(),t&&n._renderRanges(t)||(n._rootElement.remove(),delete n._rootElement),n
        }
        ...
        _renderRanges:function(n){
            var e=this,t=e._options,h=t.x,c=t.y,o=t.radius,l=e._renderer,a=e._rootElement,i=0,u=0,s=t.width>0?t.width:f(t.width.start,t.width.end);
            ...
            return(i||u)&&o+u*s>0&&o-i*s>0?(r(n,function(n,t){
                var r=(t.startWidth+t.endWidth)/2,f=l.createArc(h,c,o+u*r,o-i*r,t.endPosition,t.startPosition,{
                    stroke:"none",
                    strokeWidth:0,
                    fill:t.color
                }).append(a);
                "class"in t&&f.applySettings({
                    "class":t["class"]
                })
            }),!0):!1
        },
    ...
    n.viz.gauges.__internals.Title=n.Class.inherit({
        ...
        render:function(n){
            var t=this;
            return e(!0,t._options,n),t._root=t._root||t._renderer.createGroup().applySettings({
                "class":"dx-gauge-title"
    ...
    var u=n.viz.gauges.__factory,h=n.viz.core.Rectangle,o=n.utils.isNumber,c=n.utils.isString,l=n.utils.isFunction,s=window.isFinite,v=window.setTimeout,f=n.utils.windowResizeCallbacks,r=t.extend,e=t.each,y=500,a={
        size:{
            width:i,
            height:i
        },
    ...
    n.viz.gauges.Gauge=n.ui.Component.inherit({
        ...
        _initRenderer:function(){
            ...
            n._canvas={
                ...
                width:1,
                height:1
            }),n._rootElement=n._renderer.getRoot(),n._trackerGroup=n._renderer.createGroup({
                "class":"tracker"
            }).append(n._rootElement)
        },
        ...
        _getCanvas:function(){
            var i=this,t=i.option("size")||{},n=i.option("margin")||{},f=i._element(),e=i._getDefaultContainerSize(),r=t.width>=0?Number(t.width):f.width(),u=t.height>=0?Number(t.height):f.height();
        ...
        _prepareMainElements:function(){
            ...
            r===i&&t===i&&u===i&&(t=[{
                value:n._area.baseValue
            }]),n._renderIndicators("_rangeBars",r||[],n._getCommonRangeBarSettings(),n._createRangeBar),n._renderIndicators("_needles",t||[],n._getCommonNeedleSettings(),n._createNeedle),n._renderIndicators("_markers",u||[],n._getCommonMarkerSettings(),n._createMarker)
        },
        _updateActiveElements:function(){
            var n=this;
        ...
        _renderScale:function(){
            ...
            })),t=n._combineOptions(n._commonOptions,n._defaultOpts.commonScaleSettings,n._presetManager.getScalePreset(),r,{
                offset:0
            }),t.majorTick.customTickValues=t.majorTick.customTickValues||[],t.minorTick.customTickValues=t.minorTick.customTickValues||[],i.init(t),n._mainElements.push(i)
        },
    ...
    var u=n.viz.gauges.__factory,h=n.utils.isNumber,o=window.Number,c=n.utils.normalizeAngle,l=n.utils.getCosAndSin,r=Math.max,f=Math.min,e=Math.round,v=Array.prototype.slice,s=t.extend,a=t.each,y=Math.PI,p={
        geometry:{
            startAngle:225,
            endAngle:315,
            totalRadius:i
    ...
    n.viz.gauges.CircularGauge=n.viz.gauges.Gauge.inherit({
        ...
        _applyMainLayout:function(n){
            ...
            },i=s._layoutManager.selectRectByAspectRatio((t.down-t.up)/(t.right-t.left),o),u=f(i.width()/(t.right-t.left),i.height()/(t.down-t.up)),h,c;
        ...
        _renderMainElements:function(){
            ...
            a(n._mainElements,function(n,u){
                u.init({
                    x:i,
                    y:r,
                    radius:e(t-o(u._options.offset)||t)
                }).render()
            })
        },
    ...
    var r=n.viz.gauges.__factory,e=Math.max,s=Math.min,u=Math.round,h=Array.prototype.slice,f=t.extend,o=t.each,c={
        geometry:{
    ...
    var s=n.formatHelper,f=window.Number,h=window.String,c=n.utils.isFunction,r=Math.round,e=t.extend,o=4,u={
    ...
    n.viz.gauges.__internals.Tooltip=n.Class.inherit({
        ...
        render:function(){
            var n=this;
            return n._options.enabled?(n._rootElement=n._rootElement||n._renderer.createGroup({
                "class":"tooltip"
            }),n._rootElement.append(n._gauge._rootElement),n._shadow=n._shadow||n._renderer.createArea().append(n._rootElement),n._cloud=n._cloud||n._renderer.createArea().append(n._rootElement),n._text=n._text||n._renderer.createText().append(n._rootElement),n._shadow.applySettings({
                stroke:"none",
                strokeWidth:0,
                fill:"#000000",
                opacity:.1
            ...
            }),n._rootElement.applySettings({
                visibility:"hidden"
            }),n._visible=!1):n.clear(),n
        },
        clear:function(){
            var n=this;
        ...
        _getSettings:function(n,t,i,u,e){
            var w=this._options,a=i+2*f(w.horizontalPadding),v=u+2*f(w.verticalPadding),l=f(w.arrowLength),s=this._selectMask(n,t,a,v,l),y,b,p,h,c;
        ...
        show:function(n){
            ...
            return t._text.applySettings({
                ...
                x:0,
                y:0
            }),i=t._text.getBBox(),u=t._getSettings(n.x,n.y,i.width,i.height,n.offset||0),t._shadow.applySettings({
                points:u.shadowPoints
            }),t._cloud.applySettings({
                points:u.cloudPoints,
                fill:n.color
            }),t._text.applySettings({
                x:u.x,
                y:r(u.y-i.y-i.height/2+2)
            }),!t._visible&&t._rootElement.applySettings({
                visibility:"visible"
            })&&(t._visible=!0),t
        },
        hide:function(){
            var n=this;
            return n._visible&&n._rootElement.applySettings({
                visibility:"hidden"
            })&&(n._visible=!1),n
        },
        enabled:function(){
    ...
    var u=window.setTimeout,f=window.clearTimeout,l=window.Number,e=t.extend,o=t.each,s=Math.abs,h=200,c=3,p={
        mouseover:a,
        mouseout:v
    },r={
        mousemove:y
    ...
    n.viz.gauges.__internals.Tracker=n.Class.inherit({
        ...
        _processHoverOn:function(){
            this._gauge._tooltip.show(e(!0,this._context.target.getTooltipParameters(),{
                context:this._context.info
            }))
        },
    ...
    var u=t.viz.rangeSelector,s=t.viz.core,r=t.utils,f=u.utils,o=t.viz.core.ParseUtils,e=t.formatHelper,h=100;
    u.consts={
        fontHeightRatio:.55,
        ...
        var v=5,y={
            ...
            var s=r.isDefined(u.minVisibleX)?u.minVisibleX:u.minX,h=r.isDefined(u.maxVisibleX)?u.maxVisibleX:u.maxX;
            ...
            var f=n.extend(!0,{},t.option("scale")),h=t.option("incidentOccured"),e=0,a=new o({
                incidentOccured:h
            }),s=a.correctValueType((f.valueType||"").toLowerCase()),l;
            ...
            if(n._isUpdating=!0,i=a(n),n._actualSize=i,r=ut(n),t=vt(n,r),yt(n,i,t),i.width&&i.height&&c.is(":visible"))n.stopRedraw=!1;
            else{
    ...
    r.Scale=r.BaseVisualElement.inherit({
        ...
        _getLabelFormatOptions:function(t){
            return u.isDefined(this._options.scale.marker.label.format)?this._options.scale.marker.label:n.extend({},this._options.scale.marker.label,{
                format:t
            })
        },
        ...
        _initializeMarkersEvents:function(n,t){
            var i=this,s=this._options.canvas.top+this._options.canvas.height-this.markersAreaHeight+this._options.scale.marker.topIndent,u,f,h,e,o;
            if(n.length>0){
    ...
    var r=t.viz.rangeSelector,h=t.utils,e=window.navigator.msPointerEnabled,u=t.utils.isNumber,f=t.utils.isDate,o=0,s=1;
    ...
    r.SlidersEventsManager=t.Class.inherit(function(){
        var e=function(n){
            ...
            var r=n||window.event,t=r.originalEvent,f=r.touches,u=t?t.pointerType:!1,e=t?t.touches:!1,o=r.which===i&&r.button===1,s=o||r.which===1,h=t&&u!==i&&(u===t.MSPOINTER_TYPE_TOUCH||u===t.MSPOINTER_TYPE_MOUSE),c=f&&f.length>0||e&&e.length>0;
            return s||h||c
        },f=function(n){
            return n&&n.type&&n.type.indexOf("touch")===0
        },c=function(i,o){
            var p=i._renderer,v,c=i._slidersController,a=i._processSelectionChanged,s=c.getSlider(o),w=s.getAnotherSlider(),y,l,h;
            ...
            var v=i._renderer,c,e=i._slidersController,h=i._processSelectionChanged,y=e.getSelectedAreaTracker(),s=!1,l,a;
            ...
            var v=i._renderer,a,c=i._slidersController,l=i._processSelectionChanged,y=c.getAreaTracker(),o=!1,p=!1,h;
            y.on(r.events.start,function(r){
    ...
    var f=t.viz.rangeSelector,r=t.utils,s="ontouchstart"in window,h=window.navigator.msPointerEnabled,o={
        duration:250
    },c=8,l=20,u=0,e=1;
        ...
        return{
            _createSlider:function(){
                ...
                return t=n._renderer.createGroup({
                    ...
                    i.applySettings({
                        stroke:t?n._options.sliderHandles.color:n._options.sliderMarker.invalidRangeColor
                    })
    ...
    r.RangeView=r.BaseVisualElement.inherit(function(){
        ...
        return{
            _draw:function(n){
                ...
                }),o.append(n)),t._options.background.visible&&t._options.background.image&&t._options.background.image.url&&(s=t._renderer.createImage(i.left,i.top,i.width+1,i.height,t._options.background.image.url,{
                    location:t._options.background.image.location
                }),s.append(n)),e)for(u=t._options.seriesDataSource.getSeries(),r=0;r<u.length;r++)u[r].options.seriesGroup=n,u[r].options.seriesLabelsGroup=n,u[r].options.trackerGroup=n,u[r].draw(t._options.translator),t._options.behavior&&t._options.behavior.animationEnabled&&u[r].animate()
            }
        }
    }())
}(jQuery,DevExpress),function(n,t,i){
    ...
    u.SeriesDataSource=t.Class.inherit(function(){
        var u=function(n){
            ...
            var w=[],h,b,l,v=u(o.chart),s=o.chart.series,k=o.chart.valueAxis&&o.chart.valueAxis.valueType,y,c,a,p;
    ...
    var o=t.viz.rangeSelector,r=o.utils,f=t.utils,e=-1e3,u=function(n,t){
        ...
        var r,u,e,o,s;
        return f.isDate(n)?i==="year"||i==="quarter"||i==="month"?{
