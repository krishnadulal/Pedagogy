            ...
            <div id="right-main">
                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <table border="0" cellpadding="0" class="hbox" cellspacing="0" width="100%" align="center" >
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <% if (email1.equals("null") && email2.equals("null")) {%>
                                    <form name="courseproblem" action="solution_database.jsp?COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>&CPROB_ID=<%=rs2.getString(1)%>" method="post" enctype="multipart/form-data">
                        ...
                        <% if (email1.equals("null") && email2.equals("null")) {%>
                        <form method="post" action="courseprob_database.jsp" name="cog" onsubmit="return submitForm();">
                            ...
                            <table  align="center" style="border: #777777;border-style: solid; display:none;" width="100%" id="objectivetable">
                                <thead >
                                    <tr class="headline">
                                        <th width="2%"></th>
                                        <th width="5%">S.No.</th>
