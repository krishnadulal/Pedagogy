                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <%
                                                                    ...
                                                                    if (email1.equals("null") && email2.equals("null")) {
                        %>
                        <a href="JavaScript:window.location='modoverview_edit.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=moduleid%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                        <%
                                                                    }
                                                                    out.println("</td>");
                                                                    out.println("</tr>");
                        ...
                        <%}%>
                        <form method="post" action="modoverview_database.jsp" name="cog" onsubmit="return submitForm();">
