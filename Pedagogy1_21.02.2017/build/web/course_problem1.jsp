            ...
            <div id="right-main">
                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <table border="0" cellpadding="0" class="hbox" cellspacing="0" width="100%" align="center" >
                            <tbody>
                                ...
                                <tr>
                                    <td align="center" width="15%" style=" table-layout: fixed ;border:1px solid #E4E4E4;" rowspan="3" >
                                        <div align="center" style="display: block" id="obj" >
                                            <ol style="font-style: normal">
                                                <%
                                                                                            String[] str1 = rs2.getString(5).split("\\.");
                                    ...
                                    <td align="left" colspan="4"><h3>Course Problem<%=t++%>.</h3></td>
                                ...
                                <tr>
                                    <td style="border:1px solid #E4E4E4; " align="center">
                                        <%if (rs2.getString(7) != null) {
                                                 String ext[] = rs2.getString(7).split("\\.");
                                                 String ext1 = ext[2];

                                        %>
                                        <form action="get.jsp" method="get" id="get_<%=t%>">
                                            <input type="hidden" name="extension" value="<%=ext1%>"/>
                                            <input type="hidden" name="filename" value="<%=rs2.getString(7)%>"/>
                                            <a href="javascript:{}" id="solution" name="solution" onclick="document.getElementById('get_<%=t%>').submit();" > Solution </a>
                                        </form>
                                        <%}%>
                                    </td>
                                    <% if (email1.equals("null") && email2.equals("null")) {%>
                                    <form name="courseproblem" action="solution_database.jsp?COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>&CPROB_ID=<%=rs2.getString(1)%>" method="get" enctype="multipart/form-data">
                                    ...
                                    <td style="float: right" colspan="4">
                                       ...
                                       <a href="JavaScript:window.location='courseprob_database2.jsp?CPROB_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox"><img src="Images/images.jpg" alt="" width="20" height="20"/></a>
                                        <a href="JavaScript:window.location='courseprob_database3.jsp?CPROB_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox"><img src="Images/downimages.jpg" alt="" width="20" height="20"/></a>
                                        <a href="JavaScript:window.location='course_problem1.jsp?CPROB_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                                        <a href="JavaScript:window.location='courseprob_delete.jsp?CPROB_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>&DELETE_FILE=<%=rs2.getString(7)%>'" class="hbox">Delete</a>
                        ...
                        %>
                        <a href="JavaScript:window.location='course_problem1.jsp?CPROB_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Add Comment</a>
                        ...
                        <%                                            }
                                                                    ...
                                                                    if (rs2.getString(6) == null || rs2.getString(6).equals("")) {
                                                                        ...
                                                                        out.println("<td align='Justify' style='background-color: #F1F1F1; padding: 5px;'>" + rs2.getString(6) + "</td>");
                                                                    }
                        ...
                        <%                                            }
                                    ...
                                    try {
                                        ...
                                        if (email1.equals("null") && email2.equals("null")) {
                                            resultString = "SELECT * FROM courseproblem WHERE COURSE_ID=" + id + " AND CPROB_ID=" + cprobid + "";
                                        } else {
                                            resultString = "SELECT * FROM courseproblem WHERE COURSE_ID=" + id + " AND CPROB_ID=" + cprobid + "";
                                        }
                        ...
                        <%}%>
                        <form method="post" action="courseprob_database1.jsp" name="cog" onsubmit="return submitForm();">
                            <input name="CPROB_ID" value="<%=cprobid%>" type="hidden"/>
                            ...
                            <table style="border: #777777;border-style: solid; display:none;" width="100%" id="objectivetable">
                                <thead>
                                    <tr class="headline">
                                        ...
                                        <th width="2%"></th>
                                        <th width="5%">S.No.</th>
                                        <th width="93%">Course Objective</th>
                                    </tr>
                                </thead>
                                <%
                                                                            request.setCharacterEncoding("UTF-8");
                                                                            ...
                                                                            int m = 1;
                                                                            try {
                                                                                String resultString1 = "SELECT * FROM courseobjective where COURSE_ID='" + id + "'";
