            ...
            <div id="tabs">
                <ul>
                    ...
                    %>
                     ...
                     <li style="float: left">
                        <a href="reviewer.jsp?LOGIN=<%=login%>&PASSWORD_ID=<%=password%>" class="current">Domain Review</a>
                    </li>
            ...
            <div id="left" style="width:100%;">
                ...
                <div id="screen" style="min-height:800px">
                        ...
                        <form action="reviewer1.jsp" method="get" >
                            ...
                            <select name="Institutions">
                                ...
                                <%
                                            ...
                                            try {
                                                String resultString = " SELECT * FROM register_user WHERE DNAME ='Confirm' group by INSTITUTE";
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" class="contenttable" border="1" width="100%" style="table-layout: fixed">
                        <thead>
                            <tr>
                                <th width="22%" style="white-space:nowrap;overflow: hidden;">Course Name</th>
                                <th width="22%" style="white-space:nowrap;overflow: hidden;">Institute</th>
                                <th width="22%" style="white-space:nowrap;overflow: hidden;">Principal Developer Name</th>
                                <th width="24%" style="white-space:nowrap;overflow: hidden;">Reviewer Name</th>
                        ...
                        <tbody>
                            <%
                                        ...
                                        try {
                                            ...
                                            if (inst1.equals("All")) {
                                                queryString2 = "SELECT * FROM register_user WHERE DNAME ='Confirm'";
                                            } else {
                                                queryString2 = "SELECT * FROM register_user where INSTITUTE='" + inst1 + "' AND DNAME ='Confirm'";
                                            }
                                            ...
                                            while (rs2.next()) {
                                                ...
                                                r1_e = rs2.getString(18);
                                                r2_e = rs2.getString(22);
                                                r3_e = rs2.getString(26);
                                                r1_p = rs2.getString(30);
                                                r2_p = rs2.getString(31);
                                                r3_p = rs2.getString(32);
                            %>
                            <tr>
                                <form action="review_details.jsp" method="post" id="<%=rs2.getString(2)%>">
                                ...
                                <td>
                                    <%
                                                                                    ...
                                                                                    if (r1_p == null && r2_p == null && r3_p == null) {
                                                                                        out.print("Reviewer not Assigned");
                                                                                    }
