                        ...
                        <tbody>
                            <%
                                        ...
                                        try {
                                            ...
                                            String queryString2 = "SELECT * FROM register_user WHERE (NAME ='Confirm' OR CNAME ='Confirm' OR DNAME ='Confirm') AND PEDA_EMAIL IS NULL AND PEDA_PASSWORD IS NULL ORDER BY COURSE_NAME";
