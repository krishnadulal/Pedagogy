        ...
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  moduleobjective SET COGNITIVELEVEL = ?, ACTIONVERBS = ?, OBJECTIVE = ? WHERE COURSE_ID=" + id + " AND MOBJ_ID=" + mobjid + " AND MODULE_ID=" + moduleid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  moduleobjective SET REVIEWER_COMMENT = '" + text1 + "' WHERE COURSE_ID=" + id + " AND MOBJ_ID=" + mobjid + " AND MODULE_ID=" + moduleid + "";
                         }else{
                            queryString = "UPDATE  moduleobjective SET PEDA_REVIEW = '" + text1 + "' WHERE COURSE_ID=" + id + " AND MOBJ_ID=" + mobjid + " AND MODULE_ID=" + moduleid + "";
                            }
