...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="right-main">
                <h2 class="head">
                    Course <%=course%> -> Module <%=rs3.getString(2)%>
                </h2>
                <%} catch (Exception ex) {
                                out.println("Unable to connect to Database." + ex.getMessage());
                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <div class="home-links">
                            ...
                            <a href="module_overview.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=moduleid%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>">Module Overview</a>
                            <a href="module_objectives.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=moduleid%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>">Module Objectives</a>
                            <a href="module_unit.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=moduleid%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>">Module Units</a>
                            <a href="module_problems.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=moduleid%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>">Module Level Problems</a>
                            <a href="module_strategy.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=moduleid%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>">Module Learning Strategy</a>
