                ...
                <div id="screen">
                    <div class="boxc">
                        <%
                                    ...
                                    try {
                                        ...
                                        while (rs4.next()) {
                                            ...
                                            out.println("<tbody>");
                                            out.println("<tr>");
                                            out.println("<td align='left'><h3>Course Overview.</h3></td>");
                        ...
                        <%
                                                                    ...
                                                                    out.println("<tr>");
                                                                    out.println("<td align='Justify' >" + rs4.getString(6) + "</td>");
                                                                    out.println("</tr>");
                        %>
                        ...
                        <%
                                                                    ...
                                                                    if (email1.equals("null") && email2.equals("null")) {
                        %>
                        <a href="JavaScript:window.location='overview_edit.jsp?COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                        <%
                                                                    }
                                                                    out.println("</td>");
                                                                    out.println("</tr>");
                        ...
                        <% out.println("<table border='0' cellpadding='0' class='hbox' cellspacing='0' width='100%' align='center' >");
                                                                    out.println("<tbody>");
                                                                    out.println("<tr>");
                                                                    out.println("<td align='left'style='background-color: #B9D9FF; font-size: medium; padding: 5px;'>Pedagogy Reviewer Comment:</td>");

                                                                    out.println("</tr>");
                                                                    out.println("<tr><td  class='timestamp'>Last updated at <img width='16' height='16' title='Date and Time' src='Images/clock-white-bg.png' alt='Date and Time'><script type='text/javascript' language='JavaScript'>var x= new Date();document.write (x);</script></td></tr>");
                                                                    out.println("<tr>");
                                                                    if (rs4.getString(10) == null || rs4.getString(10).equals("")) {
                                                                        out.println("<td align='Justify' style='background-color: #F1F1F1; padding: 5px;'> &nbsp;&nbsp;&nbsp;  </td>");
                                                                    } else {

                                                                        out.println("<td align='Justify' style='background-color: #F1F1F1; padding: 5px;'>" + rs4.getString(10) + "</td>");
                                                                    }
                        ...
                        <% out.println("<table border='0' cellpadding='0' class='hbox' cellspacing='0' width='100%' align='center' >");
                                                                    out.println("<tbody>");
                                                                    out.println("<tr>");
                                                                    out.println("<td align='left'style='background-color: #B9D9FF; font-size: medium; padding: 5px;'>Reviewer Comment:</td>");

                                                                    out.println("</tr>");
                                                                    out.println("<tr><td  class='timestamp'>Last updated at <img width='16' height='16' title='Date and Time' src='Images/clock-white-bg.png' alt='Date and Time'><script type='text/javascript' language='JavaScript'>var x= new Date();document.write (x);</script></td></tr>");
                                                                    out.println("<tr>");
                                                                    if (rs4.getString(8) == null || rs4.getString(8).equals("")) {
                                                                        out.println("<td align='Justify' style='background-color: #F1F1F1; padding: 5px;'> &nbsp;&nbsp;&nbsp;  </td>");
                                                                    } else {

                                                                        out.println("<td align='Justify' style='background-color: #F1F1F1; padding: 5px;'>" + rs4.getString(8) + "</td>");
                                                                    }
                        ...
                        <%
                                    ...
                                    try {
                                        ...
                                        if (email1.equals("null") && email2.equals("null")) {
                                            resultString = "SELECT * FROM course WHERE COURSE_ID='" + id + "'";
                                        } else {
                                            resultString = "SELECT * FROM course WHERE COURSE_ID='" + id + "'";
                                        }
                        ...
                        <%} else {%>
                        <h2 align="center">Add Pedagogy Review Comment:-</h2>
                        <%}%>
                        <form method="post" action="overview_database1.jsp" name="cog" onsubmit="return submitForm();">
                            ...
                            <table align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="right" >
                                            <input value="Update" name="submit" type="submit" onclick=" return check(this.form)" />
                                        </td>
