...
<html>
    ...
    <body>
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  module SET MODULE_OVERVIEW = CONCAT((IFNull(MODULE_OVERVIEW, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  module SET REVIEWER_COMMENT = CONCAT((IFNull(REVIEWER_COMMENT, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                        }else{
                            queryString = "UPDATE  module SET PEDA_REVIEW = CONCAT((IFNull(PEDA_REVIEW, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                            }
        ...
        %>
        <jsp:forward page="module_overview.jsp">
