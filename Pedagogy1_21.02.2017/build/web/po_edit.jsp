                ...
                <div id="screen">
                    <div class="boxc">
                        <%
                                    ...
                                    try {
                                        ...
                                        while (rs4.next()) {
                                            ...
                                            out.println("<tbody>");
                                            out.println("<tr>");
                                            out.println("<td align='left'><h3>Program Educational Objective.</h3></td>");
                        ...
                        <%
                                                                    ...
                                                                    out.println("<tr>");
                                                                    out.println("<td align='Justify' >" + rs4.getString(5) + "</td>");
                                                                    out.println("</tr>");
                        %>
                        ...
                        %>
                        <a href="JavaScript:window.location='po_edit.jsp?COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                        <%
                                            out.println("</td>");
                                            out.println("</tr>");
                                            out.println("</tbody>");
                        ...
                        <h2 align="center">Program Educational Objective:-</h2>
                        <form method="post" action="po_database1.jsp" name="cog" onsubmit="return submitForm();">
