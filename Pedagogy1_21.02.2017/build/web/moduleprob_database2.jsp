    ...
    <body>
        <%
                    ...
                    try {
                        ...
                        while (rs2.next()) {
                            if (rs2.getString(1).equals(mprobid)) {
                        ...
                        String queryString = "UPDATE  moduleproblem SET MPROB_ID=999999 WHERE MPROB_ID=" + mprobid + " ";
                        pstatement = connection.prepareStatement(queryString);

                        updateQuery2 = pstatement.executeUpdate();

                        String queryString1 = "UPDATE  moduleproblem SET MPROB_ID=" + mprobid + " WHERE MPROB_ID=" + ID1 + " ";
                        pstatement = connection.prepareStatement(queryString1);

                        updateQuery3 = pstatement.executeUpdate();

                        String queryString2 = "UPDATE  moduleproblem SET MPROB_ID=" + ID1 + " WHERE MPROB_ID=999999 ";
