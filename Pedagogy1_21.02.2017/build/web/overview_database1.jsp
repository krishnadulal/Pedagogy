        ...
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  course SET COURSE_OVERVIEW = ? WHERE COURSE_ID=" + id + " ";
                       } else if(email2.equals("null")){
                            queryString = "UPDATE  course SET REVIEWER_COMMENT = ? WHERE COURSE_ID=" + id + " ";
                       }else{
                            queryString = "UPDATE  course SET PEDA_REVIEW = ? WHERE COURSE_ID=" + id + " ";
                            }
