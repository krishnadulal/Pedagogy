                ...
                <div id="screen" style="min-height:800px">
                    ...
                    <div align="left" style="border:none;font-size: 14px">
                        <div style="float: left" class="buttons">
                            <a class="button" href="JavaScript:void(0);" onclick="change('com');" >Completed List</a> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a class="button" href="JavaScript:void(0);" onclick="change('incom');">Incomplete List</a>
                        </div>
                            ...
                            <tbody>
                                <%
                                    ...
                                    try {
                                        ...
                                        if (inst1.equals("All")) {
                                            queryString2 = "SELECT * FROM register_user WHERE NAME IS NOT NULL OR DNAME IS NOT NULL OR CNAME IS NOT NULL ORDER BY COURSE_NAME";
                                        } else {
                                            queryString2 = "SELECT * FROM register_user WHERE (INSTITUTE='" + inst1 + "') AND (NAME IS NOT NULL OR DNAME IS NOT NULL OR CNAME IS NOT NULL) ORDER BY COURSE_NAME";
                                        }
                            ...
                            <tbody>
                                <%
                                    try {
                                        connection2 = DriverManager.getConnection(connectionURL, "root", "Pedagogy_cet123");
                                        if (inst1.equals("All")) {
                                            queryString2 = "SELECT * FROM register_user WHERE NAME IS NULL AND DNAME IS NULL AND CNAME IS NULL ORDER BY COURSE_NAME";
                                        } else {
                                            queryString2 = "SELECT * FROM register_user where INSTITUTE='" + inst1 + "' AND NAME IS NULL AND DNAME IS NULL AND CNAME IS NULL ORDER BY COURSE_NAME";
                                        }
