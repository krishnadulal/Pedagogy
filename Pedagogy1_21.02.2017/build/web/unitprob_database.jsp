    ...
    <body>
        <%
                   ...
                   // rte = rte.replace("'", "");
                    ...
                    try {
                        String queryString = "INSERT INTO unitproblem (PROBLEM,COURSE_ID,MODULE_ID,UNIT_ID,PROBLEMOBJECTIVE) VALUES(?,?,?,?,?)";
                        pstatement = connection.prepareStatement(queryString);
                        pstatement.setString(1, rte);
                        pstatement.setString(2, id);
                        pstatement.setString(3, moduleid);
                        pstatement.setString(4, unitid);
                        pstatement.setString(5, p);
        ...
        <jsp:forward page="unit_problem.jsp">
            ...
            <jsp:param name="UPROB_ID" value="<%=uprobid%>"/>
