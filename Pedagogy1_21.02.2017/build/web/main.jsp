                        ...
                        <tbody>
                            <%
                                        ...
                                        try {
                                            ...
                                            String queryString2 = "SELECT * FROM register_user WHERE DNAME ='Confirm' AND R1_PASSWORD IS NULL AND R2_PASSWORD IS NULL AND R3_PASSWORD IS NULL ORDER BY COURSE_NAME";
