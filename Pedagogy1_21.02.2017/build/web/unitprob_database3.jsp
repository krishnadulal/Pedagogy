    ...
    <body>
        <%
                    ...
                    try {
                        ...
                        rs2.beforeFirst();
                        while (rs2.next()) {
                            if (rs2.getString(1).equals(uprobid)) {
                        ...
                        String queryString = "UPDATE  unitproblem SET UPROB_ID=999999 WHERE UPROB_ID=" + uprobid + " ";
                        pstatement = connection.prepareStatement(queryString);

                        updateQuery2 = pstatement.executeUpdate();

                        String queryString1 = "UPDATE  unitproblem SET UPROB_ID=" + uprobid + " WHERE UPROB_ID=" + ID1 + " ";
                        pstatement = connection.prepareStatement(queryString1);

                        updateQuery3 = pstatement.executeUpdate();

                        String queryString2 = "UPDATE  unitproblem SET UPROB_ID=" + ID1 + " WHERE UPROB_ID=999999 ";
