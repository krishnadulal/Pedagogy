            ...
            <div id="right-main">
                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <p></p>
                        <script type="text/javascript">
                        function details(id,module_id){
                    $.ajax({
                        url: "<%= request.getContextPath()%>/ajax/module_objective_search.jsp",
                        data:{action:"details", db: "moduleobjective", identifier: id, module:module_id }
                    }).done(function(){
                    ...
                    while (table.hasChildNodes()) {
                        ...
                        for (var i = 0; i < response.length; i++){
                            ...
                            input_Tag.setAttribute('value',response[i].mobj_id);
        ...
        return false;
                ...
                <table align="center" width="100%" style="height: 200px;overflow: scroll;table-layout: fixed;">
                    <tbody>
                            ...
                            <td bgcolor="lightgrey">
                                <fieldset class="fset">
                                    <div class="borngeek-stylized-input-container" >
                                        <form action="moduleobj_database.jsp" method="post" id="multi_obj" name="multi_obj">
                        ...
                        <% if (email1.equals("null") && email2.equals("null")) {%>
                        <form method="post" action="moduleobj_database.jsp" name="cog">
                            <input name="COURSE_ID" value="<%=id%>" type="hidden"/>
                            <input name="MODULE_ID" value="<%=moduleid%>" type="hidden"/>
                            <input name="email" value="<%=email%>" type="hidden"/>
                            <input name="email1" value="<%=email1%>" type="hidden"/>
