            ...
            <div id="left" style="width:100%;">
                ...
                <div id="screen" style="min-height:800px">
                    ...
                    <div align="left" style="border:none;font-size: 14px">
                        <form action="peda_reviewer1.jsp" method="post" >
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" class="contenttable" border="1" width="100%" style="table-layout: fixed">
                        <thead>
                            <tr>
                                ...
                                <th width="19%" style="white-space:nowrap;overflow: hidden;">Principal Developer Name</th>
                                <th width="19%" style="white-space:nowrap;overflow: hidden;">Pedagogy Reviewer Name</th>
                                
                                <% if ("cetiitkgp".equals(login) && "Pedagogy_cetiitkgp".equals(password)) {%>
                                <th width="13%" style="white-space:nowrap;overflow: hidden;">Domain Review</th>
                                <th width="13%" style="white-space:nowrap;overflow: hidden;">Back to Developer</th>
                                <%}%>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <%
                                        ...
                                        //String btop = request.getParameter("btop");
                                        ...
                                        try {
                                            ...
                                            String queryString2 = "SELECT * FROM register_user WHERE NAME ='Confirm' OR CNAME ='Confirm'";
...
%>
                            <tr>
                                ...
                                <% if ("cetiitkgp".equals(login) && "Pedagogy_cetiitkgp".equals(password)) {%>
                                <%if ("Confirm".equals(cstatus) || "con".equals(cstatus)) {%>
                                <td>
                                ...
                                <%} else {%>
                                <form action="con_review.jsp" method="post" id="report_<%=rs2.getString(1)%>">
                                    <input type="hidden" name="USER_ID" value="<%=rs2.getString(1)%>" />
                                    <input type="hidden" name="COURSE_NAME" value="<%=coursename%>"/>
                                    ...
                                    <td>
                                        <div style="margin-top:2px;" class="buttons">
                                            <input type="submit" class="button" name="dstatus" value="Domain Review" />

                                        </div>
                                    </td>
                                </form>
                                <%}%>
                                <form action="course_details.jsp" method="get" id="report_<%=rs2.getString(1)%>">
                                    <input type="hidden" name="USER_ID" value="<%=rs2.getString(1)%>" />
                                    <input type="hidden" name="COURSE_NAME" value="<%=coursename%>"/>
                                    <input type="hidden" name="LOGIN" value="<%=login%>" />
                                    <input type="hidden" name="PASSWORD_ID" value="<%=password%>" />
                                    <td>
                                        <div style="margin-top:2px;" class="buttons">
                                            <input type="submit" class="button" name="btod" value="Back to Developer" />
                                        </div>
                                    </td>
                                </form>
                                <%}%>
