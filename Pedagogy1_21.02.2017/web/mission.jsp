...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body onload="initListGroup('Cog', document.forms[0].Cognitivelevel, document.forms[0].Actionverbs);" style="background-image: none" bgcolor="#FAEBD7">
        ...
        <div id="main">
            ...
            <div id="right-main">
                <h2 class="head">
                    Course <%=course%>: Institute's mission
                </h2>
                ...
                <div id="screen">
                    <div class="boxc">
                        <%
                                    ...
                                    ResultSet rs4 = null;
                                    Class.forName("com.mysql.jdbc.Driver").newInstance();
                                    connection4 = DriverManager.getConnection(connectionURL1, "root", "Pedagogy_cet123");
                                    int t = 1;
                                    try {
                                        ...
                                        while (rs4.next()) {
                                            ...
                                            out.println("<tbody>");
                                            out.println("<tr>");
                                            out.println("<td align='left'><h3>Institute's mission:</h3></td>");
                        ...
                        <%
                                                                    ...
                                                                    out.println("<tr>");
                                                                    out.println("<td align='Justify' >" + rs4.getString(3) + "</td>");
                                                                    out.println("</tr>");
                        %>
                        ...
                        %>
                        <a href="JavaScript:window.location='mission_edit.jsp?COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                        <%}
                                            out.println("</td>");
                                            out.println("</tr>");
                                            out.println("</tbody>");
                        ...
                        <h2 align="center">Institute's mission:-</h2>
                        <form method="post" action="mission_database1.jsp" name="cog" id="abc" onsubmit="return submitForm();">
