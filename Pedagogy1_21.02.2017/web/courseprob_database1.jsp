        ...
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  courseproblem SET  PROBLEM = ?,PROBLEMOBJECTIVE=? WHERE COURSE_ID=" + id + " AND CPROB_ID=" + cprobid + " ";
                         } else if(email2.equals("null")){
                            queryString = "UPDATE  courseproblem SET  REVIEWER_COMMENT = ? WHERE COURSE_ID=" + id + " AND CPROB_ID=" + cprobid + " ";
                        }else{
                            queryString = "UPDATE  courseproblem SET  PEDA_REVIEW = ? WHERE COURSE_ID=" + id + " AND CPROB_ID=" + cprobid + " ";
                            }
                        if (email1.equals("null") && email2.equals("null")) {
