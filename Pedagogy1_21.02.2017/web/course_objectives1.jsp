                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <%
                            ...
                            try {
                                String resultString = "SELECT * FROM courseobjective WHERE COURSE_ID=" + id + " AND COBJ_ID=" + cobjid + "";
                        ...
                        <form method="post" action="courseobj_database1.jsp" name="cog">
                            <input name="COBJ_ID" value="<%=rs1.getString(1)%>" type="hidden"/>
                            <input name="COURSE_ID" value="<%=rs1.getString(6)%>" type="hidden"/>
