...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body onload="initListGroup('Cog', document.forms[0].Cognitivelevel, document.forms[0].Actionverbs);" style="background-image: none" bgcolor="#FAEBD7">
        ...
        <div id="main">
            ...
            <div id="right-main">
                <h2 class="head">
                    Course <%=course%> -> Module <%=rs3.getString(2)%>:Overview
                </h2>
                <%} catch (Exception ex) {
                                out.println("Unable to connect to Database." + ex.getMessage());
                ...
                <div id="screen">
                    <div class="boxc">
                        <%
                                    ...
                                    int t = 1;
                                    try {
                                        String resultString = "SELECT * FROM module WHERE COURSE_ID='" + id + "' AND MODULE_ID='" + moduleid + "'";
                                        ...
                                        while (rs2.next()) {
                                            ...
                                            out.println("<tbody>");
                                            out.println("<tr>");
                                            out.println("<td align='left'><h3>Module's Overview.</h3></td>");
                        ...
                        <%
                                                                    ...
                                                                    out.println("<tr>");
                                                                    out.println("<td align='Justify' >" + rs2.getString(3) + "</td>");
                                                                    out.println("</tr>");
                        %>
                        ...
                        <%
                                                                    ...
                                                                    if (email1.equals("null") && email2.equals("null")) {
                        %>
                        <a href="JavaScript:window.location='modoverview_edit.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=rs2.getString(1)%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                        ...
                        <%
                                    ...
                                    try {
                                        ...
                                        if (email1.equals("null") && email2.equals("null")) {
                                            resultString = "SELECT * FROM module WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                                        } else {
                                            resultString = "SELECT * FROM module WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                                        }
                        ...
                        <%
                                                                    if (email1.equals("null") && email2.equals("null")) {
                        %>
                        <h2 align="center">Module's Overview:-</h2>
                        <%} else {%>
                        <h2 align="center">Add Comment:-</h2>

                        <%}%>
                        <form method="post" action="modoverview_database1.jsp" name="cog" onsubmit="return submitForm();">
