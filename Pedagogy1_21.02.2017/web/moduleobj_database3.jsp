    ...
    <body>
        <%
                    ...
                    try {
                        ...
                        rs2.beforeFirst();
                        while (rs2.next()) {
                            if (rs2.getString(1).equals(mobjid)) {
                        ...
                        String queryString = "UPDATE  moduleobjective SET MOBJ_ID=999999 WHERE MOBJ_ID=" + mobjid + " ";
                        pstatement = connection.prepareStatement(queryString);

                        updateQuery2 = pstatement.executeUpdate();

                        String queryString1 = "UPDATE  moduleobjective SET MOBJ_ID=" + mobjid + " WHERE MOBJ_ID=" + ID1 + " ";
                        pstatement = connection.prepareStatement(queryString1);

                        updateQuery3 = pstatement.executeUpdate();

                        String queryString2 = "UPDATE  moduleobjective SET MOBJ_ID=" + ID1 + " WHERE MOBJ_ID=999999 ";
