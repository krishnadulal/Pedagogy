...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body onload="initListGroup('Cog', document.forms[0].Cognitivelevel, document.forms[0].Actionverbs);" style="background-image: none" bgcolor="#FAEBD7">
        ...
        <div id="main">
            ...
            <div id="right-main">
                <h2 class="head">
                    Course <%=course%> -> Module <%=rs5.getString(2)%>: Strategy
                </h2>
                <%} catch (Exception ex) {
                                out.println("Unable to connect to Database." + ex.getMessage());
                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <form method="post" action="strategy_database.jsp" name="cog" onsubmit="return submitForm();">
