<%-- 
    Document   : unitdelete
    Created on : Jun 19, 2013, 6:59:49 PM
    Author     : Krishna
--%>
    ...
    <body>
        <%
                    ...
                    try {
                        ...
                        String queryString1 = "DELETE FROM unit WHERE MODULE_ID='" + moduleid + "' AND COURSE_ID='" + id + "' AND UNIT_ID='" + unitid + "' ";
                        pstatement = connection.prepareStatement(queryString1);

                        updateQuery2 = pstatement.executeUpdate();
                        String queryString2 = "DELETE FROM unitobjective WHERE MODULE_ID='" + moduleid + "' AND COURSE_ID='" + id + "' AND UNIT_ID='" + unitid + "' ";
                        pstatement1 = connection.prepareStatement(queryString2);

                        updateQuery3 = pstatement1.executeUpdate();
                        String queryString3 = "DELETE FROM unitproblem WHERE MODULE_ID='" + moduleid + "' AND COURSE_ID='" + id + "' AND UNIT_ID='" + unitid + "' ";
                        pstatement2 = connection.prepareStatement(queryString3);
