                   ...
                   // rte = rte.replace("'", "");
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  unit SET UNIT_SUMMARY = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  unit SET REVIEWER_COMMENT = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                        }else{
                            queryString = "UPDATE  unit SET PEDA_REVIEW = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                            }
