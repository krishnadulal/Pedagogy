                    ...
                    <div class="boxc">
                        ...
                        <%
                                    ...
                                    try {
                                        ...
                                        if (email1.equals("null")) {
                                            resultString = "SELECT * FROM unit WHERE COURSE_ID='" + id + "' AND MODULE_ID='" + moduleid + "' AND UNIT_ID='" + unitid + "'";
                                        } else {
                                            resultString = "SELECT * FROM unit WHERE COURSE_ID='" + id + "' AND MODULE_ID='" + moduleid + "' AND UNIT_ID='" + unitid + "'";
                                        }
                        ...
                        <%}%>
                        <form method="post" action="summary_database1.jsp" name="cog" onsubmit="return submitForm();">
