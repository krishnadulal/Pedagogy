    ...
    <body>
        <%
                    ...
                    try {
                        ...
                        rs2.beforeFirst();
                        while (rs2.next()) {
                            if (rs2.getString(1).equals(cobjid)) {
                        ...
                        String queryString = "UPDATE  courseobjective SET COBJ_ID=999999 WHERE COBJ_ID=" + cobjid + " ";
                        pstatement = connection.prepareStatement(queryString);

                        updateQuery2 = pstatement.executeUpdate();

                        String queryString1 = "UPDATE  courseobjective SET COBJ_ID=" + cobjid + " WHERE COBJ_ID=" + ID1 + " ";
                        pstatement = connection.prepareStatement(queryString1);

                        updateQuery3 = pstatement.executeUpdate();

                        String queryString2 = "UPDATE  courseobjective SET COBJ_ID=" + ID1 + " WHERE COBJ_ID=999999 ";
