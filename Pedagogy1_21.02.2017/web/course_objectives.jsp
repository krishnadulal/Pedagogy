                ...
                <div id="screen">
                    <div class="boxc">
                        ...
                        <%
                            ...
                            int t = 1;
                            try {
                                String resultString = "SELECT * FROM courseobjective WHERE COURSE_ID='" + id + "'";
                                ...
                                while (rs2.next()) {
                                    ...
                                    out.println("<table border='0' cellpadding='0' class='hbox' cellspacing='0' width='75%' align='center' >");
                                    out.println("<tbody>");

                                    out.println("<tr>");
                                    out.println("<td align='left'><h3>Objective " + t++ + ".</h3></td>");
                        ...
                        <a href="JavaScript:window.location='courseobj_database2.jsp?COBJ_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox"><img src="Images/images.jpg" alt="" width="20" height="20"/></a>
                        <a href="JavaScript:window.location='courseobj_database3.jsp?COBJ_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox"><img src="Images/downimages.jpg" alt="" width="20" height="20"/></a>
                        <a href="JavaScript:window.location='course_objectives1.jsp?COBJ_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                        <a href="JavaScript:window.location='courseobj_delete.jsp?COBJ_ID=<%=rs2.getString(1)%>&COURSE_ID=<%=id%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Delete</a>
                        <%
                            }
                            out.println("</td>");
                            out.println("</tr>");
                        ...
                        <div id="dialog<%=t%>" style=" display:    none;
                            ...
                            <form action="courseobj_database1.jsp"  method="get" id="abc">
                                <input name="email" value="<%=email%>" type="hidden"/>
                                <input name="email1" value="<%=email1%>" type="hidden"/>
                                <input name="email2" value="<%=email2%>" type="hidden"/>
                                <input name="COBJ_ID" value="<%=rs2.getString(1)%>" type="hidden"/>
                        ...
                        <script type="text/javascript">
                            function details(id, course) {
                                $.ajax({
                                    url: "<%= request.getContextPath()%>/ajax/course_objective_search.jsp",
                                    data: {action: "details", db: "courseobjective", identifier: id, course_name: course}
                                }).done(function () {
                                    ...
                                    for (var i = 0; i < response.length; i++) {
                                        ...
                                        input_Tag.setAttribute('value', response[i].cobj_id);
                        ...
                        <div id="popup" align="center" style="display: none;overflow: scroll;width: 80%;" >
                                        ...
                                        <td bgcolor="lightgrey">
                                            <fieldset class="fset">
                                                <div class="borngeek-stylized-input-container" >
                                                    <form action="courseobj_database.jsp" method="post" id="multi_obj" name="multi_obj">
                        ...
                        <% if (email1.equals("null") && email2.equals("null")) {%>
                        <form method="post" action="courseobj_database.jsp" name="cog">
                            <input name="COURSE_ID" value="<%=id%>" type="hidden"/>
                            <input name="email" value="<%=email%>" type="hidden"/>
                            <input name="email1" value="<%=email1%>" type="hidden"/>
                            <input name="email2" value="<%=email2%>" type="hidden"/>
                                        ...
                                        <td align="center">
                                            ...
                                            <tr valign="middle" >
                                                <td align="right" width="36%">
                                                    <b style="font-size: medium">Cognitive level:</b>
                                                </td>
                                                <td width="30%">
                                                    <b style="font-size: large;float: left"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ADD OBJECTIVE:--</b>

                                                </td>
                                                <td  align="left" width="8%">
                                                    <b style="font-size: medium">Action Verbs:</b>
                                                </td >
