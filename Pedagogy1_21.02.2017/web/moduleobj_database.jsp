...
<html>
    ...
    <body>
        <%
                    ...
                    try {
                        if (text != null) {
                        String queryString1 = "INSERT INTO moduleobjective (COGNITIVELEVEL,ACTIONVERBS,OBJECTIVE,TIME,COURSE_ID,MODULE_ID) VALUES('" + Cognitivelevel + "' ,'" + Actionverbs + "' ,'" + text3 + "' , now(),'" + id + "','" + moduleid + "')";
                        pstatement = connection.prepareStatement(queryString1);
                        updateQuery2 = pstatement.executeUpdate();
                        } else {
                            for (int s = 0; s < objectives.length; s++) {
                                ResultSet rs2 = null;
                                String queryString2 = "SELECT * FROM moduleobjective where MOBJ_ID=" + objectives[s] + "";
                                pstatement = connection.prepareStatement(queryString2);
                                rs2 = pstatement.executeQuery();
                                while (rs2.next()) {
                                    String queryString3 = "INSERT INTO moduleobjective (COGNITIVELEVEL,ACTIONVERBS,OBJECTIVE,TIME,COURSE_ID,MODULE_ID) VALUES('" + rs2.getString(2) + "' ,'" + rs2.getString(3) + "' , '" + rs2.getString(4) + "' , now(),'" + id + "','" + moduleid + "')";
        ...
        <jsp:forward page="module_objectives.jsp">
