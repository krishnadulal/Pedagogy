...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <script type="text/javascript">
        ...
        function chMd1()
        {
            var a=document.getElementById("Disciplines").value;
            if(a=='All')
            {
                return false;
            }
    ...
    <body>
        ...
        <div id="main" style="min-height:800px">
            <div id="left" style="width:100%;">
                <div id="flash"></div>
                <h2 class="head"> All Disciplines</h2>
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" class="contenttable" border="1" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th width="90%" style="white-space:nowrap;">Discipline</th>
                        ...
                        <tbody>
                            <%
                                        ...
                                        try {
                                            ...
                                            String queryString2 = "SELECT * FROM register_user GROUP BY DISCIPLINE";
                            ...
                            %>
                            <tr>
                                <form action="discipline1.jsp" method="post" id="<%=rs2.getString(4)%>">
                                    ...
                                    <input type="hidden" name="Disciplines" value="<%=rs2.getString(4)%>"/>
                                    <td style="white-space:nowrap;"><%=i++%></td>
                                    <td style="white-space:nowrap;"><a href="javascript:;" onclick="document.getElementById('<%=rs2.getString(4)%>').submit();"><%=rs2.getString(4)%></a></td>
                                </form>
                            </tr>
