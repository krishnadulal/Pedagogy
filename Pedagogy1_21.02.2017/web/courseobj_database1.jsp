        ...
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  courseobjective SET COGNITIVELEVEL = ?, ACTIONVERBS = ?, OBJECTIVE = ? WHERE COURSE_ID=" + id + " AND COBJ_ID=" + cobjid + " ";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  courseobjective SET REVIEWER_COMMENT = '" + text1 + "' WHERE COURSE_ID=" + id + " AND COBJ_ID=" + cobjid + " ";
                        }else{
                            queryString = "UPDATE  courseobjective SET PEDA_REVIEW = '" + text1 + "' WHERE COURSE_ID=" + id + " AND COBJ_ID=" + cobjid + " ";
                            }
                        if (email1.equals("null") && email2.equals("null")) {
