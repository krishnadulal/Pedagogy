<%-- 
    Document   : modulename_change
    Created on : Jan 30, 2014, 2:12:32 PM
    Author     : Prasanta
--%>
...
<html>
    ...
    <body>
        <%
                    ...
                    String module_change = request.getParameter("MODULE_CHANGE");
                    ...
                    String modulename = request.getParameter("" + module_change + "");
                    ...
                    try {
                        String queryString = "UPDATE  module SET MODULE_NAME = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " ";
