...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body onload="initListGroup('Cog', document.forms[0].Cognitivelevel, document.forms[0].Actionverbs);" style="background-image: none" bgcolor="#FAEBD7">
        ...
        <div id="main">
            ...
            <div id="right-main">
                <h2 class="head">
                    Course <%=course%> -> Module <%=rs5.getString(2)%>: Module's Learning Strategy
                </h2>
                <%} catch (Exception ex) {
                                out.println("Unable to connect to Database." + ex.getMessage());
                ...
                <div id="screen">
                    <div class="boxc">
                        <%
                                    ...
                                    try {
                                        ...
                                        while (rs2.next()) {
                                            ...
                                            out.println("<tbody>");
                                            out.println("<tr>");
                                            out.println("<td align='left'><h3>Module's Learning Strategy:</h3></td>");
                        ...
                        <%
                                                                    ...
                                                                    if (email1.equals("null") && email2.equals("null")) {
                        %>
                        <a href="JavaScript:window.location='strategy_edit.jsp?COURSE_ID=<%=id%>&MODULE_ID=<%=moduleid%>&email=<%=email%>&email1=<%=email1%>&email2=<%=email2%>&LOGIN=<%=login%>&PASSWORD_ID=<%=password_id%>'" class="hbox">Edit</a>
                        ...
                        <%
                                                                    if (email1.equals("null") && email2.equals("null")) {
                        %>
                        <h2 align="center">Module's Learning Strategy:-</h2>
                        <%} else {%>
                        <h2 align="center">Add Comment:-</h2>

                        <%}%>
                        <form method="post" action="strategy_database1.jsp" name="cog" onsubmit="return submitForm();">
