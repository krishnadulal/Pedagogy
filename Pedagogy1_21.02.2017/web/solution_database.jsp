<%--
    Document   : solution_database
    Created on : Sep 5, 2013, 7:58:26 PM
    Author     : Prasanta
--%>
...
<html>
    ...
    <body>
        <%
                    ...
                    String cprob_id = request.getParameter("CPROB_ID");
                    String l = "C_";
                    String m = l.concat(id);
                    String a = m.concat(".");
                    String Filename = a.concat(cprob_id);
                    File file;
                    String format = "none";
                    ...
                    try {
                        ...
                        while (i.hasNext()) {
                            ...
                            if (!fi.isFormField()) {
                                ...
                                //fullpath = replace1.replace("\\", "/");
                                //replace2 = fullpath.replaceFirst("/", "//");
                    ...
                    try {
                        String queryString1 = "UPDATE courseproblem SET SOLUTION_FILE=? WHERE CPROB_ID='" + cprob_id + "' AND COURSE_ID='" + id + "' ";
