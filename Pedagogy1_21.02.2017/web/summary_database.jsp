...
<html>
    ...
    <body>
                   ...
                   // rte = rte.replaceAll("'", "");
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  unit SET UNIT_SUMMARY = CONCAT((IFNull(UNIT_SUMMARY, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  unit SET REVIEWER_COMMENT = CONCAT((IFNull(REVIEWER_COMMENT, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                        }else{
                            queryString = "UPDATE  unit SET PEDA_REVIEW = CONCAT((IFNull(PEDA_REVIEW, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + "";
                            }
        ...
        %>
        <jsp:forward page="unit_summary.jsp">
