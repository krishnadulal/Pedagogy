    ...
    <script type="text/javascript">
        function check()
        {
           ...
           // var password = document.getElementById('password').value;
            ...
            window.location="review_login.jsp?LOGIN="+login+"&PASSWORD_ID="+password_id+"&USER_ID="+user_id;
            ...
            <div id="left" style="width:100%;">
                ...
                <div id="screen" style="min-height:800px">
                    ...
                    <div style="margin-top:2px; float:right;" class="buttons">
                        <a class="button" href="javascript:void(0)" onclick="check ();">Domain Review Page</a>
                    </div>
