                    ...
                    try {
                        String queryString = null;
                         if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  module SET MODULE_STRATEGY = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  module SET STRATEGY_COMMENT = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                        }else{
                            queryString = "UPDATE  module SET PEDA_STRATEGY = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                            }
