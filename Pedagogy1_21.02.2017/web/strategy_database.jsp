...
<html>
    ...
    <body>
        <%
                    ...
                    try {
                        ...
                        if (email1.equals("null") && email2.equals("null")) {
                            queryString = "UPDATE  module SET MODULE_STRATEGY = CONCAT((IFNull(MODULE_STRATEGY, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                        } else if(email2.equals("null")){
                            queryString = "UPDATE  module SET STRATEGY_COMMENT = CONCAT((IFNull(STRATEGY_COMMENT, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                       }else{
                            queryString = "UPDATE  module SET PEDA_STRATEGY = CONCAT((IFNull(PEDA_STRATEGY, '')),'" + rte + "') WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + "";
                            }
        ...
        %>
        <jsp:forward page="module_strategy.jsp">
