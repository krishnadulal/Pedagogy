<%-- 
    Document   : unitname_change
    Created on : Feb 3, 2014, 1:32:04 PM
    Author     : Prasanta
--%>
...
<html>
    ...
    <body>
        <%
                    ...
                    String unit_change = request.getParameter("UNIT_CHANGE");
                    ...
                    String unitname = request.getParameter("" + unit_change + "");
                    ...
                    try {
                        String queryString = "UPDATE  unit SET UNIT_NAME = ? WHERE COURSE_ID=" + id + " AND MODULE_ID=" + moduleid + " AND UNIT_ID=" + unitid + " ";
                        pstatement = connection.prepareStatement(queryString);
                        pstatement.setString(1,unitname);
