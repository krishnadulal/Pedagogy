        ...
        <div id="header" class="noprint">
            ...
            <div id="tabs">
                <ul>
                    ...
                    <li style="float: right">
                        <a href="main.jsp?LOGIN=<%=login%>&PASSWORD_ID=<%=password%>" class="current" >Assign Reviewer</a>
                    </li>
                    <li style="float: right">
                        ...
                        <form action="main1.jsp" method="get" >
                            ...
                            <select name="Institutions">
                                ...
                                <%
                                            ...
                                            try {
                                                String resultString = " SELECT * FROM register_user WHERE DNAME ='Confirm' AND R1_PASSWORD IS NULL AND R2_PASSWORD IS NULL AND R3_PASSWORD IS NULL group by INSTITUTE";
                        ...
                        <tbody>
                            <%
                                        ...
                                        try {
                                            ...
                                            if (inst1.equals("All")) {
                                                queryString2 = "SELECT * FROM register_user WHERE DNAME ='Confirm' AND R1_PASSWORD IS NULL AND R2_PASSWORD IS NULL AND R3_PASSWORD IS NULL ORDER BY COURSE_NAME";
                                            } else {
                                                queryString2 = "SELECT * FROM register_user WHERE DNAME ='Confirm' AND R1_PASSWORD IS NULL AND R2_PASSWORD IS NULL AND R3_PASSWORD IS NULL AND INSTITUTE='" + inst1 + "' ORDER BY COURSE_NAME";
                                            }
                            ...
                            %>
                            <tr>
                                <form action="course_review.jsp" method="post" id="<%=rs2.getString(2)%>">
